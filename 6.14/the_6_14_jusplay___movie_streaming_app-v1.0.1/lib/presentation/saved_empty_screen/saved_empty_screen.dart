import 'notifier/saved_empty_notifier.dart';
...
class SavedEmptyScreen extends ConsumerStatefulWidget {
  ...
  @override
  SavedEmptyScreenState createState() => SavedEmptyScreenState();
}

class SavedEmptyScreenState extends ConsumerState<SavedEmptyScreen> {
