...
import 'notifier/home_recently_watched_notifier.dart';
...
class HomeRecentlyWatchedPage extends ConsumerStatefulWidget {
...
class HomeRecentlyWatchedPageState
    extends ConsumerState<HomeRecentlyWatchedPage> {
  @override
              ...
              return CarouselSlider.builder(
                options: CarouselOptions(
                  ...
                  onPageChanged: (
                    ...
                    ref.watch(homeRecentlyWatchedNotifier).sliderIndex = index;
                  },
                ),
                itemCount: ref
                        .watch(homeRecentlyWatchedNotifier)
                        .homeRecentlyWatchedModelObj
                        ?.widget1ItemList
                        .length ??
                    0,
                itemBuilder: (context, index, realIndex) {
                  Widget1ItemModel model = ref
                          .watch(homeRecentlyWatchedNotifier)
                          .homeRecentlyWatchedModelObj
              ...
              builder: (context, ref, _) {
                return SizedBox(
                  ...
                  child: AnimatedSmoothIndicator(
                    activeIndex:
                        ref.watch(homeRecentlyWatchedNotifier).sliderIndex,
                    count: ref
                            .watch(homeRecentlyWatchedNotifier)
                            .homeRecentlyWatchedModelObj
                            ?.widget1ItemList
