...
class DownloadedModel extends Equatable {
  DownloadedModel({this.downloadedItemList = const []}) {}

  List<DownloadedItemModel> downloadedItemList;

  DownloadedModel copyWith({List<DownloadedItemModel>? downloadedItemList}) {
  ...
  @override
  List<Object?> get props => [downloadedItemList];
}
