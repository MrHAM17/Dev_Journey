...
import 'package:the_5_08_shopsie___e_commerce_app/widgets/app_bar/appbar_trailing_image.dart';
import 'package:the_5_08_shopsie___e_commerce_app/widgets/app_bar/custom_app_bar.dart';
import 'package:the_5_08_shopsie___e_commerce_app/widgets/custom_drop_down.dart';
...
import 'provider/main_landing_provider.dart';

class MainLandingScreen extends StatefulWidget {
  const MainLandingScreen({Key? key})
      : super(
          key: key,
        );

  @override
  MainLandingScreenState createState() => MainLandingScreenState();
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => MainLandingProvider(),
      child: MainLandingScreen(),
    );
  }
}

class MainLandingScreenState extends State<MainLandingScreen> {
  ...
  Widget _buildFrame(BuildContext context) {
    return SizedBox(
      height: 296.v,
      child: Consumer<MainLandingProvider>(
        builder: (context, provider, child) {
          return ListView.separated(
            ...
            itemCount: provider.mainLandingModelObj.frameItemList.length,
            itemBuilder: (context, index) {
              FrameItemModel model =
                  provider.mainLandingModelObj.frameItemList[index];
          ...
          Consumer<MainLandingProvider>(
            builder: (context, provider, child) {
              return ListView.separated(
                ...
                itemCount:
                    provider.mainLandingModelObj.thirtytwoItemList.length,
                itemBuilder: (context, index) {
                  ThirtytwoItemModel model =
                      provider.mainLandingModelObj.thirtytwoItemList[index];
        ...
        Consumer<MainLandingProvider>(
          builder: (context, provider, child) {
            return GridView.builder(
              ...
              physics: NeverScrollableScrollPhysics(),
              itemCount:
                  provider.mainLandingModelObj.mainlandingItemList.length,
              itemBuilder: (context, index) {
                MainlandingItemModel model =
                    provider.mainLandingModelObj.mainlandingItemList[index];
            ...
            child: Row(
              children: [
                ...
                Padding(
                  ...
                  child: Selector<MainLandingProvider, MainLandingModel?>(
                    selector: (
                      context,
                      provider,
                    ) =>
                        provider.mainLandingModelObj,
                    builder: (context, mainLandingModelObj, child) {
                      return CustomDropDown(
                        ...
                        onChanged: (value) {
                          context.read<MainLandingProvider>().onSelected(value);
                        },
                      );
                    },
                  ),
                ...
                child: Selector<MainLandingProvider, MainLandingModel?>(
                  ...
                  builder: (context, mainLandingModelObj, child) {
                    return CustomDropDown(
                      ...
                      onChanged: (value) {
                        context.read<MainLandingProvider>().onSelected2(value);
                      },
                    );
                  },
                ),
            ...
            child: Consumer<MainLandingProvider>(
              builder: (context, provider, child) {
                return ListView.separated(
                  ...
                  itemCount: provider.mainLandingModelObj.priceItemList.length,
                  itemBuilder: (context, index) {
                    PriceItemModel model =
                        provider.mainLandingModelObj.priceItemList[index];
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              Selector<MainLandingProvider, TextEditingController?>(
                selector: (
                  context,
                  provider,
                ) =>
