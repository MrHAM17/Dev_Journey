...
import 'provider/find_doctors_provider.dart';
...
class FindDoctorsScreen extends StatefulWidget {
  ...
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
        create: (context) => FindDoctorsProvider(), child: FindDoctorsScreen());
  }
}

class FindDoctorsScreenState extends State<FindDoctorsScreen> {
  @override
  void initState() {
    super.initState();
  }
        ...
        child: Scaffold(
            ...
            body: Container(
                ...
                child: Column(
                    ...
                    children: [
                      Selector<FindDoctorsProvider, TextEditingController?>(
  ...
  Widget _buildCategories(BuildContext context) {
    return Padding(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Consumer<FindDoctorsProvider>(builder: (context, provider, child) {
            return GridView.builder(
                ...
                itemCount:
                    provider.findDoctorsModelObj.finddoctorsItemList.length,
                itemBuilder: (context, index) {
                  FinddoctorsItemModel model =
                      provider.findDoctorsModelObj.finddoctorsItemList[index];
    ...
    return Container(
        ...
        child: Column(
            ...
            children: [
              ...
              SizedBox(
                  height: 107.v,
                  child: Consumer<FindDoctorsProvider>(
                    ...
                    return ListView.separated(
                        ...
                        itemCount:
                            provider.findDoctorsModelObj.doctorsItemList.length,
                        itemBuilder: (context, index) {
                          DoctorsItemModel model = provider
