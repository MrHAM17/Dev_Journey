...
import 'package:the_5_06_helthio___telehealth/widgets/custom_pin_code_text_field.dart';
import 'provider/reset_password_verify_code_provider.dart';
...
class ResetPasswordVerifyCodeScreen extends StatefulWidget {
  ...
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
        create: (context) => ResetPasswordVerifyCodeProvider(),
            ...
            body: Container(
                ...
                child: Column(children: [
                  ...
                  Padding(
                      ...
                      child: Selector<ResetPasswordVerifyCodeProvider,
