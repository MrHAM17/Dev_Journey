...
import 'package:the_5_06_helthio___telehealth/widgets/custom_rating_bar.dart';
import 'provider/drugs_detail_provider.dart';
...
class DrugsDetailScreen extends StatefulWidget {
  ...
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
        create: (context) => DrugsDetailProvider(), child: DrugsDetailScreen());
  }
}

class DrugsDetailScreenState extends State<DrugsDetailScreen> {
  @override
  void initState() {
    super.initState();
