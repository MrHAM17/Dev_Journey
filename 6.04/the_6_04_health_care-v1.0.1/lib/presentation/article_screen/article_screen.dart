...
import 'notifier/article_notifier.dart';
                ...
                child: Column(children: [
                  Consumer(builder: (context, ref, _) {
                    return CustomSearchView(
                        controller: ref.watch(articleNotifier).searchController,
      ...
      Consumer(builder: (context, ref, _) {
        return ListView.separated(
            ...
            itemCount: ref
                ...
                0,
            itemBuilder: (context, index) {
              RelatedarticlesItemModel model = ref
                      .watch(articleNotifier)
                      .articleModelObj
                      ?.relatedarticlesItemList[index] ??
