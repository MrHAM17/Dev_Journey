...
class AccountsScreen extends StatelessWidget {
  ...
  Widget _buildLastTransaction(BuildContext context) {
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      Text("Last Transaction", style: theme.textTheme.titleMedium),
          ...
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            ...
            Row(mainAxisAlignment: MainAxisAlignment.center, children: [
              ...
              Padding(
                  padding: EdgeInsets.only(top: 14.v, bottom: 15.v),
                  child:
                      Text("+780", style: CustomTextStyles.labelLargeGreen600))
            ])
          ]))
    ]);
  }
  ...
  Widget _buildDebitCreditOverview(BuildContext context) {
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      Text("Debit & Credit Overview", style: theme.textTheme.titleMedium),
      SizedBox(height: 14.v),
      Container(
  ...
  Widget _buildInvoicesSent(BuildContext context) {
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      Text("Invoices Sent", style: theme.textTheme.titleMedium),
      SizedBox(height: 13.v),
      Container(
          padding: EdgeInsets.all(20.h),
          decoration: AppDecoration.white
