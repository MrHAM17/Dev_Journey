...
import 'provider/no_history_provider.dart';

class NoHistoryScreen extends StatefulWidget {
  ...
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
        create: (context) => NoHistoryProvider(), child: NoHistoryScreen());
  }
}

class NoHistoryScreenState extends State<NoHistoryScreen> {
  @override
  void initState() {
    super.initState();
  }
