...
import 'package:the_5_14_jusplay___movie_streaming_app/presentation/home_page/home_page.dart';
  ...
  Widget _buildWidget(BuildContext context) {
    return SizedBox(
      ...
      child: Stack(
        ...
        children: [
          Consumer<HomeTabContainerProvider>(
            builder: (context, provider, child) {
              return CarouselSlider.builder(
                ...
                itemCount:
                    provider.homeTabContainerModelObj.widgetItemList.length,
                itemBuilder: (context, index, realIndex) {
                  WidgetItemModel model =
                      provider.homeTabContainerModelObj.widgetItemList[index];
