import '../follow_artists_screen/widgets/followartists_item_widget.dart';import 'models/followartists_item_model.dart';import 'notifier/follow_artists_notifier.dart';import 'package:flutter/material.dart';import 'package:the_6_18_tune_cast___music_streaming__podcast_app/core/app_export.dart';import 'package:the_6_18_tune_cast___music_streaming__podcast_app/widgets/app_bar/appbar_leading_image.dart';import 'package:the_6_18_tune_cast___music_streaming__podcast_app/widgets/app_bar/appbar_title.dart';import 'package:the_6_18_tune_cast___music_streaming__podcast_app/widgets/app_bar/custom_app_bar.dart';import 'package:the_6_18_tune_cast___music_streaming__podcast_app/widgets/custom_elevated_button.dart';import 'package:the_6_18_tune_cast___music_streaming__podcast_app/widgets/custom_outlined_button.dart';class FollowArtistsScreen extends ConsumerStatefulWidget {const FollowArtistsScreen({Key? key}) : super(key: key);

@override FollowArtistsScreenState createState() =>  FollowArtistsScreenState();

 }
class FollowArtistsScreenState extends ConsumerState<FollowArtistsScreen> {@override Widget build(BuildContext context) { return SafeArea(child: Scaffold(appBar: _buildAppBar(context), body: Container(width: double.maxFinite, padding: EdgeInsets.symmetric(horizontal: 24.h, vertical: 26.v), child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [Container(width: 357.h, margin: EdgeInsets.only(right: 22.h), child: Text("msg_follow_your_favorite".tr, maxLines: 2, overflow: TextOverflow.ellipsis, style: theme.textTheme.bodyLarge!.copyWith(height: 1.40))), SizedBox(height: 32.v), _buildFollowArtists(context)])), bottomNavigationBar: _buildAutoLayoutVertical(context))); } 
/// Section Widget
...
/// Section Widget
Widget _buildFollowArtists(BuildContext context) { return Consumer(builder: (context, ref, _) {return ListView.separated(physics: NeverScrollableScrollPhysics(), shrinkWrap: true, separatorBuilder: (context, index) {return SizedBox(height: 16.v);}, itemCount: ref.watch(followArtistsNotifier).followArtistsModelObj?.followartistsItemList.length ?? 0, itemBuilder: (context, index) {FollowartistsItemModel model = ref.watch(followArtistsNotifier).followArtistsModelObj?.followartistsItemList[index] ?? FollowartistsItemModel(); return FollowartistsItemWidget(model);});}); } 
/// Section Widget
