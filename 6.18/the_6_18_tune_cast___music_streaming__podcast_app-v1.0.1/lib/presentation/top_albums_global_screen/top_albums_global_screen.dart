import '../top_albums_global_screen/widgets/topalbumsglobal2_item_widget.dart';import 'models/topalbumsglobal2_item_model.dart';import 'notifier/top_albums_global_notifier.dart';import 'package:flutter/material.dart';import 'package:the_6_18_tune_cast___music_streaming__podcast_app/core/app_export.dart';import 'package:the_6_18_tune_cast___music_streaming__podcast_app/widgets/app_bar/appbar_leading_image.dart';import 'package:the_6_18_tune_cast___music_streaming__podcast_app/widgets/app_bar/custom_app_bar.dart';class TopAlbumsGlobalScreen extends ConsumerStatefulWidget {const TopAlbumsGlobalScreen({Key? key}) : super(key: key);

@override TopAlbumsGlobalScreenState createState() =>  TopAlbumsGlobalScreenState();

 }
class TopAlbumsGlobalScreenState extends ConsumerState<TopAlbumsGlobalScreen> {@override Widget build(BuildContext context) { return SafeArea(child: Scaffold(appBar: _buildAppBar(context), body: Container(width: double.maxFinite, padding: EdgeInsets.symmetric(horizontal: 24.h, vertical: 30.v), child: Column(children: [_buildPrice(context), SizedBox(height: 18.v), Text("msg_top_albums_global2".tr, style: theme.textTheme.headlineSmall), SizedBox(height: 12.v), Text("msg_the_most_played".tr, style: CustomTextStyles.titleMediumMedium), SizedBox(height: 14.v), Text("msg_by_hearme_12_24_2022".tr, style: CustomTextStyles.titleSmallGray70001), SizedBox(height: 23.v), Divider(), SizedBox(height: 23.v), _buildTopAlbumsGlobal(context)])))); } 
/// Section Widget
...
/// Section Widget
Widget _buildTopAlbumsGlobal(BuildContext context) { return Padding(padding: EdgeInsets.only(left: 8.h), child: Consumer(builder: (context, ref, _) {return ListView.separated(physics: NeverScrollableScrollPhysics(), shrinkWrap: true, separatorBuilder: (context, index) {return SizedBox(height: 24.v);}, itemCount: ref.watch(topAlbumsGlobalNotifier).topAlbumsGlobalModelObj?.topalbumsglobal2ItemList.length ?? 0, itemBuilder: (context, index) {Topalbumsglobal2ItemModel model = ref.watch(topAlbumsGlobalNotifier).topAlbumsGlobalModelObj?.topalbumsglobal2ItemList[index] ?? Topalbumsglobal2ItemModel(); return Topalbumsglobal2ItemWidget(model, onTapSongCard: () {onTapSongCard(context);});});})); } 
