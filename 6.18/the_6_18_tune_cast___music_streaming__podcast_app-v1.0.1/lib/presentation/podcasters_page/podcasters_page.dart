...
class PodcastersPageState extends ConsumerState<PodcastersPage>
    ...
    return Consumer(
      builder: (context, ref, _) {
        return ListView.separated(
          ...
          itemCount: ref
                  .watch(podcastersNotifier)
                  .podcastersModelObj
                  ?.podcastersItemList
                  .length ??
              0,
          itemBuilder: (context, index) {
            PodcastersItemModel model = ref
                    .watch(podcastersNotifier)
                    .podcastersModelObj
