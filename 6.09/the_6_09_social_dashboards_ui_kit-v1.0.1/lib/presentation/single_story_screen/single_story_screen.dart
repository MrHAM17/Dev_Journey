import 'notifier/single_story_notifier.dart';
...
class SingleStoryScreen extends ConsumerStatefulWidget {
...
class SingleStoryScreenState extends ConsumerState<SingleStoryScreen> {
  @override
      ...
      child: Consumer(
        builder: (context, ref, _) {
          return CustomTextFormField(
            controller: ref.watch(singleStoryNotifier).commentController,
