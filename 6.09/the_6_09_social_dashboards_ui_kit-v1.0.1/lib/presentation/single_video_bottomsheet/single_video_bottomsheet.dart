...
import 'notifier/single_video_notifier.dart';
...
class SingleVideoBottomsheet extends ConsumerStatefulWidget {
  ...
  @override
  SingleVideoBottomsheetState createState() => SingleVideoBottomsheetState();
}

class SingleVideoBottomsheetState
    extends ConsumerState<SingleVideoBottomsheet> {
  @override
          ...
          builder: (context, ref, _) {
            return Wrap(
              ...
              children: List<Widget>.generate(
                ref
                        .watch(singleVideoNotifier)
                        .singleVideoModelObj
                        ?.tagsItemList
                        .length ??
                    0,
                (index) {
                  TagsItemModel model = ref
                          .watch(singleVideoNotifier)
                          .singleVideoModelObj
                          ?.tagsItemList[index] ??
                      TagsItemModel();
                  ...
                  return TagsItemWidget(
                    ...
                    onSelectedChipView1: (value) {
                      ref
                          .read(singleVideoNotifier.notifier)
