import 'notifier/search_results_notifier.dart';
...
import 'package:the_6_09_social_dashboards_ui_kit/widgets/app_bar/appbar_title_searchview_one.dart';
...
import 'package:the_6_09_social_dashboards_ui_kit/presentation/single_post_bottomsheet/single_post_bottomsheet.dart';
...
class SearchResultsScreenState extends ConsumerState<SearchResultsScreen> {
    ...
    return CustomAppBar(
        ...
        title: Consumer(builder: (context, ref, _) {
          return AppbarTitleSearchviewOne(
              ...
              controller: ref.watch(searchResultsNotifier).searchController);
        }),
  ...
  /// Shows a modal bottom sheet with [SinglePostBottomsheet]
  /// widget content.
  ...
  onTapCard03(BuildContext context) {
    showModalBottomSheet(
        context: context,
        builder: (_) => SinglePostBottomsheet(),
