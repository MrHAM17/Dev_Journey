...
import 'notifier/all_activity_dropdown_notifier.dart';
...
class AllActivityDropdownScreen extends ConsumerStatefulWidget {
...
class AllActivityDropdownScreenState
    extends ConsumerState<AllActivityDropdownScreen> {
  @override
            ...
            title: Consumer(
              builder: (context, ref, _) {
                return AppbarTitleDropdown(
                  ...
                  items: ref
                          .watch(allActivityDropdownNotifier)
                          .allActivityDropdownModelObj
                          ?.dropdownItemList ??
                      [],
                  onTap: (value) {
                    ref.watch(allActivityDropdownNotifier).onSelected(value);
                  },
                );
              },
            ),
