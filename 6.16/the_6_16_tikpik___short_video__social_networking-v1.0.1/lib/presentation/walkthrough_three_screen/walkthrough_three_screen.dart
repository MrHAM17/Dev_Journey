import 'notifier/walkthrough_three_notifier.dart';import 'package:flutter/material.dart';import 'package:smooth_page_indicator/smooth_page_indicator.dart';import 'package:the_6_16_tikpik___short_video__social_networking/core/app_export.dart';import 'package:the_6_16_tikpik___short_video__social_networking/widgets/custom_elevated_button.dart';class WalkthroughThreeScreen extends ConsumerStatefulWidget {const WalkthroughThreeScreen({Key? key}) : super(key: key);

@override WalkthroughThreeScreenState createState() =>  WalkthroughThreeScreenState();

 }
class WalkthroughThreeScreenState extends ConsumerState<WalkthroughThreeScreen> {@override Widget build(BuildContext context) { return SafeArea(child: Scaffold(body: SizedBox(width: double.maxFinite, child: Column(children: [Spacer(), CustomImageView(imagePath: ImageConstant.img8, height: 197.v, width: 363.h), SizedBox(height: 82.v), _buildAutoLayoutVertical(context)])))); } 
/// Section Widget
