import 'notifier/add_option_notifier.dart';
...
class AddOptionScreen extends ConsumerStatefulWidget {
...
class AddOptionScreenState extends ConsumerState<AddOptionScreen> {
              ...
              Consumer(
                builder: (context, ref, _) {
                  return CustomTextFormField(
                    width: 160.h,
                    controller:
                        ref.watch(addOptionNotifier).stateInactiveController,
              ...
              Consumer(
                builder: (context, ref, _) {
                  return CustomTextFormField(
                    width: 160.h,
                    controller:
                        ref.watch(addOptionNotifier).stateInactiveController1,
