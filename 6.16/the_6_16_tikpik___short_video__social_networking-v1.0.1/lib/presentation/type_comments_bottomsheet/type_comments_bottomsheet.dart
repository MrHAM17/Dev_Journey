...
import 'notifier/type_comments_notifier.dart';
...
class TypeCommentsBottomsheet extends ConsumerStatefulWidget {
...
class TypeCommentsBottomsheetState
    extends ConsumerState<TypeCommentsBottomsheet> {
  @override
      ...
      child: Consumer(
        builder: (context, ref, _) {
          return ListView.separated(
            ...
            itemCount: ref
                    .watch(typeCommentsNotifier)
                    .typeCommentsModelObj
                    ?.typecommentsItemList
                    .length ??
                0,
            itemBuilder: (context, index) {
              TypecommentsItemModel model = ref
                      .watch(typeCommentsNotifier)
                      .typeCommentsModelObj
                      ?.typecommentsItemList[index] ??
