...
class PaymentMethodScreen extends StatelessWidget {
          ...
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            ...
            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
              BlocSelector<PaymentMethodBloc, PaymentMethodState,
                  ...
                  selector: (state) => state.inputsFiedController,
                  builder: (context, inputsFiedController) {
  ...
  Widget _buildPaymentMethode(BuildContext context) {
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      BlocSelector<PaymentMethodBloc, PaymentMethodState, PaymentMethodModel?>(
          selector: (state) => state.paymentMethodModelObj,
          builder: (context, paymentMethodModelObj) {
            return ListView.separated(
                ...
                itemCount:
                    paymentMethodModelObj?.paymentmethodlistItemList.length ??
                        0,
                itemBuilder: (context, index) {
                  PaymentmethodlistItemModel model =
