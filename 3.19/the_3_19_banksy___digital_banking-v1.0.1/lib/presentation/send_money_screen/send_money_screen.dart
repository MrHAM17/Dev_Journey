...
import 'package:the_3_19_banksy___digital_banking/widgets/app_bar/appbar_trailing_iconbutton.dart';
                  ...
                  BlocSelector<SendMoneyBloc, SendMoneyState, SendMoneyModel?>(
                      ...
                      builder: (context, sendMoneyModelObj) {
                        return ListView.separated(
                            ...
                            itemCount:
                                sendMoneyModelObj?.profilelistItemList.length ??
                                    0,
                            itemBuilder: (context, index) {
                              ProfilelistItemModel model = sendMoneyModelObj
                          ...
                          return ListView.separated(
                              ...
                              itemCount:
                                  sendMoneyModelObj?.nineteenItemList.length ??
                                      0,
                              itemBuilder: (context, index) {
                                NineteenItemModel model = sendMoneyModelObj
          ...
          BlocSelector<SendMoneyBloc, SendMoneyState, SendMoneyModel?>(
              ...
              builder: (context, sendMoneyModelObj) {
                return ListView.separated(
                    ...
                    itemCount: sendMoneyModelObj?.twentytwoItemList.length ?? 0,
                    itemBuilder: (context, index) {
                      TwentytwoItemModel model =
                          sendMoneyModelObj?.twentytwoItemList[index] ??
                              TwentytwoItemModel();
