              ...
              builder: (context, mobilePrepaidOneModelObj) {
                return ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      Profilelist1ItemModel model = mobilePrepaidOneModelObj
            ...
            BlocSelector<MobilePrepaidOneBloc, MobilePrepaidOneState,
                ...
                builder: (context, mobilePrepaidOneModelObj) {
                  return ListView.separated(
                      ...
                      itemCount:
                          mobilePrepaidOneModelObj?.fortytwoItemList.length ??
                              0,
                      itemBuilder: (context, index) {
      ...
      BlocSelector<MobilePrepaidOneBloc, MobilePrepaidOneState,
          ...
          builder: (context, mobilePrepaidOneModelObj) {
            return ListView.separated(
                ...
                itemCount:
                    mobilePrepaidOneModelObj?.thirtysevenItemList.length ?? 0,
                itemBuilder: (context, index) {
                  ThirtysevenItemModel model =
                      mobilePrepaidOneModelObj?.thirtysevenItemList[index] ??
