...
import com.shopsieecommerceapp.app.modules.messages.ui.MessagesFragment
import kotlin.Int
import kotlin.String
import kotlin.collections.List

class MessagesTabContainerActivityPagerAdapter(
    ...
    companion object AdapterConstant {
        ...
        val viewPages: List<Fragment> =
                listOf(MessagesFragment(),MessagesFragment(),MessagesFragment())
