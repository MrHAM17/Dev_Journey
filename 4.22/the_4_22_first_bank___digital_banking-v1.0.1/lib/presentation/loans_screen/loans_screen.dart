import '../loans_screen/widgets/userprofile1_item_widget.dart';
...
class LoansScreen extends GetWidget<LoansController> {
    ...
    return SizedBox(
      ...
      child: Obx(
        () => ListView.separated(
          ...
          itemCount:
              controller.loansModelObj.value.userprofile1ItemList.value.length,
          itemBuilder: (context, index) {
            Userprofile1ItemModel model = controller
                .loansModelObj.value.userprofile1ItemList.value[index];
  ...
  /// Section Widget
  Widget _buildActiveLoansOverview() {
    return Column(
