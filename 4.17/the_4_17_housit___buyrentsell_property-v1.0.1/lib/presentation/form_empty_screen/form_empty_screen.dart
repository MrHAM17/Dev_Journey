import 'controller/form_empty_controller.dart';import 'package:flutter/material.dart';import 'package:the_4_17_housit___buyrentsell_property/core/app_export.dart';import 'package:the_4_17_housit___buyrentsell_property/core/utils/validation_functions.dart';import 'package:the_4_17_housit___buyrentsell_property/widgets/app_bar/appbar_leading_iconbutton.dart';import 'package:the_4_17_housit___buyrentsell_property/widgets/app_bar/custom_app_bar.dart';import 'package:the_4_17_housit___buyrentsell_property/widgets/custom_elevated_button.dart';import 'package:the_4_17_housit___buyrentsell_property/widgets/custom_text_form_field.dart';import 'package:the_4_17_housit___buyrentsell_property/domain/googleauth/google_auth_helper.dart';import 'package:the_4_17_housit___buyrentsell_property/domain/facebookauth/facebook_auth_helper.dart';
// ignore_for_file: must_be_immutable
class FormEmptyScreen extends GetWidget<FormEmptyController> {FormEmptyScreen({Key? key}) : super(key: key);

GlobalKey<FormState> _formKey = GlobalKey<FormState>();

@override Widget build(BuildContext context) { return SafeArea(child: Scaffold(resizeToAvoidBottomInset: false, appBar: _buildAppBar(), body: SizedBox(width: SizeUtils.width, child: SingleChildScrollView(padding: EdgeInsets.only(bottom: MediaQuery.of(context).viewInsets.bottom), child: Form(key: _formKey, child: Container(width: double.maxFinite, padding: EdgeInsets.symmetric(horizontal: 24.h, vertical: 50.v), child: Column(children: [Align(alignment: Alignment.centerLeft, child: Text("msg_let_s_sign_in".tr, style: theme.textTheme.headlineSmall)), SizedBox(height: 30.v), Align(alignment: Alignment.centerLeft, child: Text("msg_quis_nostrud_exercitation".tr, style: theme.textTheme.bodyMedium)), SizedBox(height: 50.v), _buildEmail(), SizedBox(height: 15.v), _buildPassword(), SizedBox(height: 12.v), _buildForgotPassword(), SizedBox(height: 35.v), _buildLogin(), SizedBox(height: 18.v), _buildItemSeparator(), SizedBox(height: 18.v), _buildGoogle(), SizedBox(height: 5.v)]))))), bottomNavigationBar: _buildSeventySeven())); } 
/// Section Widget
...
/// Section Widget
Widget _buildForgotPassword() { return Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [Text("msg_forgot_password".tr, style: CustomTextStyles.titleSmallPrimary), Text("lbl_show_password".tr, style: CustomTextStyles.titleSmallMedium)]); } 
/// Section Widget
Widget _buildLogin() { return CustomElevatedButton(text: "lbl_login".tr); } 
/// Section Widget
