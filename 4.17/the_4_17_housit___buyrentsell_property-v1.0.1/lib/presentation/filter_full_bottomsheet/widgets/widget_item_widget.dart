  ...
  Widget build(BuildContext context) {
    return Obx(
      () => RawChip(
        ...
        label: Text(
          widgetItemModelObj.buttonCategory!.value,
          style: TextStyle(
        ...
        selected: (widgetItemModelObj.isSelected?.value ?? false),
        backgroundColor: appTheme.gray100,
        selectedColor: appTheme.gray100,
        shape: (widgetItemModelObj.isSelected?.value ?? false)
        ...
        onSelected: (value) {
          widgetItemModelObj.isSelected!.value = value;
        },
      ),
    );
  }
