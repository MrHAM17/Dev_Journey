import 'transactiontype_item_model.dart';import '../../../core/app_export.dart';import 'layout24_item_model.dart';import 'package:the_4_17_housit___buyrentsell_property/data/models/selectionPopupModel/selection_popup_model.dart';import 'layout25_item_model.dart';import 'viewallreviews_item_model.dart';import 'propertydetails_item_model.dart';/// This class defines the variables used in the [property_details_screen],
...
Rx<List<Layout24ItemModel>> layout24ItemList = Rx([Layout24ItemModel(bedroom:ImageConstant.imgMdiBedEmpty.obs,bedroomCounter: "2 Bedroom".obs),Layout24ItemModel(bedroom:ImageConstant.imgTelevisionPrimary.obs,bedroomCounter: "1 Bathroom".obs),Layout24ItemModel(bedroom:ImageConstant.imgContrast.obs,bedroomCounter: "2 Bedroom".obs)]);
...
Rx<List<Layout25ItemModel>> layout25ItemList = Rx([Layout25ItemModel(hospitalCounter: "2 Hospital".obs),Layout25ItemModel(hospitalCounter: "4 Gas stations".obs),Layout25ItemModel(hospitalCounter: "2 Schools".obs)]);
