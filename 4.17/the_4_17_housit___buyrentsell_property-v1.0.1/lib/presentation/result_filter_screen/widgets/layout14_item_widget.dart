          ...
          SizedBox(
            ...
            child: Stack(
              ...
              children: [
                Obx(
                  () => CustomImageView(
                    imagePath: layout14ItemModelObj.image!.value,
                    height: 140.v,
                    width: 168.h,
                        ...
                        Obx(
                          () => CustomIconButton(
                            ...
                            child: CustomImageView(
                              imagePath: layout14ItemModelObj.favorite!.value,
                            ),
                          ),
                        ),
            ...
            child: Column(
              ...
              children: [
                SizedBox(
                  ...
                  child: Obx(
                    () => Text(
                      layout14ItemModelObj.bridgelandModernHouse!.value,
                      maxLines: 2,
                ...
                Row(
                  children: [
                    ...
                    Padding(
                      ...
                      child: Obx(
                        () => Text(
                          layout14ItemModelObj.text!.value,
                ...
                Row(
                  children: [
                    ...
                    Padding(
                      ...
                      child: Obx(
                        () => Text(
                          layout14ItemModelObj.semarangIndonesia!.value,
                ...
                Row(
                  children: [
                    Obx(
                      () => Text(
                        layout14ItemModelObj.price!.value,
                    ...
                    Padding(
                      ...
                      child: Obx(
                        () => Text(
                          layout14ItemModelObj.month!.value,
