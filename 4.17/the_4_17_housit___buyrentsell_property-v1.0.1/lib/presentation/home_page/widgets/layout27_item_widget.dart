          ...
          SizedBox(
            ...
            child: Stack(
              ...
              children: [
                Obx(
                  () => CustomImageView(
                    imagePath: layout27ItemModelObj.image!.value,
                    height: 140.v,
                    width: 126.h,
                        ...
                        Obx(
                          () => CustomIconButton(
                            ...
                            child: CustomImageView(
                              imagePath: layout27ItemModelObj.favorite!.value,
                            ),
                          ),
                        ),
            ...
            child: Column(
              ...
              children: [
                SizedBox(
                  ...
                  child: Obx(
                    () => Text(
                      layout27ItemModelObj.skyDandelionsApartment!.value,
                      maxLines: 2,
                ...
                Row(
                  children: [
                    ...
                    Padding(
                      ...
                      child: Obx(
                        () => Text(
                          layout27ItemModelObj.text!.value,
                ...
                Row(
                  children: [
                    ...
                    Padding(
                      ...
                      child: Obx(
                        () => Text(
                          layout27ItemModelObj.jakartaIndonesia!.value,
                ...
                Row(
                  children: [
                    Obx(
                      () => Text(
                        layout27ItemModelObj.price!.value,
                    ...
                    Padding(
                      ...
                      child: Obx(
                        () => Text(
                          layout27ItemModelObj.month!.value,
