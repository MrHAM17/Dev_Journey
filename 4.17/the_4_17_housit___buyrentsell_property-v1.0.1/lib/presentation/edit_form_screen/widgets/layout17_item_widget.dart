  ...
  Widget build(BuildContext context) {
    return Obx(
      () => RawChip(
        ...
        label: Text(
          layout17ItemModelObj.buttonCategory!.value,
          style: TextStyle(
            color: (layout17ItemModelObj.isSelected?.value ?? false)
                ? appTheme.whiteA700
        ...
        selected: (layout17ItemModelObj.isSelected?.value ?? false),
        backgroundColor: appTheme.gray100,
        selectedColor: theme.colorScheme.primary,
        shape: (layout17ItemModelObj.isSelected?.value ?? false)
        ...
        onSelected: (value) {
          layout17ItemModelObj.isSelected!.value = value;
        },
      ),
    );
  }
