  ...
  Widget build(BuildContext context) {
    return Obx(
      () => RawChip(
        ...
        label: Text(
          layout15ItemModelObj.buttonCategory!.value,
          style: TextStyle(
        ...
        selected: (layout15ItemModelObj.isSelected?.value ?? false),
        backgroundColor: theme.colorScheme.primary,
        selectedColor: theme.colorScheme.primary,
        shape: (layout15ItemModelObj.isSelected?.value ?? false)
        ...
        onSelected: (value) {
          layout15ItemModelObj.isSelected!.value = value;
        },
      ),
    );
  }
