      ...
      child: Column(
        ...
        children: [
          SizedBox(
            ...
            child: Stack(
              ...
              children: [
                Obx(
                  () => CustomImageView(
                    imagePath: verticalItemModelObj.theLaurelsVilla!.value,
                    height: 160.v,
                    width: 144.h,
                            ...
                            Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Obx(
                                    () => Text(
                                      verticalItemModelObj.price!.value,
                                  ...
                                  Padding(
                                    ...
                                    child: Obx(
                                      () => Text(
                                        verticalItemModelObj.month!.value,
                                        style:
          ...
          Padding(
            ...
            child: Obx(
              () => Text(
                verticalItemModelObj.theLaurelsVilla1!.value,
            ...
            child: Row(
              children: [
                SizedBox(
                  ...
                  child: Row(
                    ...
                    children: [
                      Obx(
                        () => CustomImageView(
                          imagePath: verticalItemModelObj.image!.value,
                          height: 9.adaptSize,
                          width: 9.adaptSize,
                      ...
                      Padding(
                        ...
                        child: Obx(
                          () => Text(
                            verticalItemModelObj.text!.value,
                ...
                Padding(
                  ...
                  child: Obx(
                    () => Text(
                      verticalItemModelObj.baliIndonesia!.value,
