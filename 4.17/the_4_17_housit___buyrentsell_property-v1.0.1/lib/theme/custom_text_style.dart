...
class CustomTextStyles {
  ...
  static get bodyMediumBluegray80001_1 => theme.textTheme.bodyMedium!.copyWith(
        color: appTheme.blueGray80001,
      );
  ...
  static get bodySmallBluegray80001_2 => theme.textTheme.bodySmall!.copyWith(
        color: appTheme.blueGray80001,
      );
  ...
  static get labelLargeBluegray600Medium_1 =>
      theme.textTheme.labelLarge!.copyWith(
        color: appTheme.blueGray600,
        fontWeight: FontWeight.w500,
      );
  ...
  static get labelLargeMontserrat => theme.textTheme.labelLarge!.montserrat;
