...
import 'notifier/job_type_notifier.dart';
...
class JobTypeScreen extends ConsumerStatefulWidget {
...
class JobTypeScreenState extends ConsumerState<JobTypeScreen> {
  @override
    ...
    return SizedBox(
        ...
        child: Consumer(builder: (context, ref, _) {
          return ListView.separated(
              ...
              itemCount: ref
                      .watch(jobTypeNotifier)
                      .jobTypeModelObj
                      ?.jobtypeItemList
                      .length ??
                  0,
              itemBuilder: (context, index) {
                JobtypeItemModel model = ref
                        .watch(jobTypeNotifier)
                        .jobTypeModelObj
