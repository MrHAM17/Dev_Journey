...
import 'notifier/job_details_tab_container_notifier.dart';
...
class JobDetailsTabContainerScreen extends ConsumerStatefulWidget {
...
class JobDetailsTabContainerScreenState
    extends ConsumerState<JobDetailsTabContainerScreen>
            ...
            builder: (context, ref, _) {
              return Wrap(
                ...
                children: List<Widget>.generate(
                  ref
                          .watch(jobDetailsTabContainerNotifier)
                          .jobDetailsTabContainerModelObj
                          ?.framefiveItemList
                          .length ??
                      0,
                  (index) {
                    FramefiveItemModel model = ref
                            .watch(jobDetailsTabContainerNotifier)
                            .jobDetailsTabContainerModelObj
                    ...
                    return FramefiveItemWidget(
                      ...
                      onSelectedChipView1: (value) {
                        ref
                            .read(jobDetailsTabContainerNotifier.notifier)
        ...
        builder: (context, ref, _) {
          return ListView.separated(
            ...
            itemBuilder: (context, index) {
              JobdetailstabcontainerItemModel model = ref
                      .watch(jobDetailsTabContainerNotifier)
                      .jobDetailsTabContainerModelObj
