import 'notifier/sign_up_create_acount_notifier.dart';
...
class SignUpCreateAcountScreen extends ConsumerStatefulWidget {
...
class SignUpCreateAcountScreenState
    extends ConsumerState<SignUpCreateAcountScreen> {
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Consumer(builder: (context, ref, _) {
            return CustomTextFormField(
                controller:
                    ref.watch(signUpCreateAcountNotifier).emailController,
