...
import 'package:the_6_11_hired___job_search/widgets/app_bar/appbar_leading_circleimage.dart';
import 'package:the_6_11_hired___job_search/widgets/app_bar/appbar_subtitle.dart';
import 'package:the_6_11_hired___job_search/widgets/app_bar/appbar_subtitle_one.dart';
        ...
        child: Consumer(
          builder: (context, ref, _) {
            return ListView.separated(
              ...
              itemCount:
                  ref.watch(homeNotifier).homeModelObj?.frameItemList.length ??
                      0,
          ...
          builder: (context, ref, _) {
            return ListView.separated(
              ...
              itemCount: ref
                  ...
                  0,
              itemBuilder: (context, index) {
                EightyeightItemModel model = ref
                        .watch(homeNotifier)
                        .homeModelObj
                        ?.eightyeightItemList[index] ??
