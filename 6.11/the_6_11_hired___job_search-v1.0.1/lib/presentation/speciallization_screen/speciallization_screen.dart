...
import 'notifier/speciallization_notifier.dart';
...
import 'package:the_6_11_hired___job_search/presentation/confirmation_dialog/confirmation_dialog.dart';

class SpeciallizationScreen extends ConsumerStatefulWidget {
...
class SpeciallizationScreenState extends ConsumerState<SpeciallizationScreen> {
  @override
    ...
    return Padding(
        ...
        child: Consumer(builder: (context, ref, _) {
          return ListView.separated(
              ...
              itemCount: ref
                      .watch(speciallizationNotifier)
                      .speciallizationModelObj
                      ?.speciallizationItemList
                      .length ??
                  0,
              itemBuilder: (context, index) {
                SpeciallizationItemModel model = ref
                        .watch(speciallizationNotifier)
                        .speciallizationModelObj
                        ?.speciallizationItemList[index] ??
