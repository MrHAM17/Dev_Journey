...
import 'package:the_6_11_hired___job_search/presentation/logout_popup_dialog/logout_popup_dialog.dart';
  ...
  Widget _buildAccount1(BuildContext context) {
    return Column(children: [
      ...
      _buildPrivacy(context,
          ...
          experience: "lbl_personal_info".tr, onTapPrivacy: () {
      ...
      _buildPrivacy(context,
          ...
          experience: "lbl_experience".tr, onTapPrivacy: () {
  ...
  Widget _buildGeneral(BuildContext context) {
    return Column(children: [
      ...
      _buildPrivacy(context,
          ...
          experience: "lbl_notification".tr, onTapPrivacy: () {
      ...
      _buildPrivacy(context,
          ...
          experience: "lbl_language".tr, onTapPrivacy: () {
