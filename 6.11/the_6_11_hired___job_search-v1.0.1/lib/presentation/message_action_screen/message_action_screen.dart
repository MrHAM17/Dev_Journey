...
import 'notifier/message_action_notifier.dart';
import 'package:flutter/material.dart';
import 'package:the_6_11_hired___job_search/core/app_export.dart';
import 'package:the_6_11_hired___job_search/presentation/home_page/home_page.dart';
import 'package:the_6_11_hired___job_search/presentation/message_page/message_page.dart';
import 'package:the_6_11_hired___job_search/presentation/profile_page/profile_page.dart';
import 'package:the_6_11_hired___job_search/presentation/saved_page/saved_page.dart';
...
import 'package:the_6_11_hired___job_search/widgets/custom_bottom_bar.dart';
...
class MessageActionScreen extends ConsumerStatefulWidget {
  const MessageActionScreen({Key? key}) : super(key: key);

  @override
  MessageActionScreenState createState() => MessageActionScreenState();
}

// ignore_for_file: must_be_immutable
class MessageActionScreenState extends ConsumerState<MessageActionScreen> {
    ...
    return Consumer(builder: (context, ref, _) {
      return ListView.separated(
          ...
          itemBuilder: (context, index) {
            MessageactionItemModel model = ref
                    .watch(messageActionNotifier)
                    .messageActionModelObj
