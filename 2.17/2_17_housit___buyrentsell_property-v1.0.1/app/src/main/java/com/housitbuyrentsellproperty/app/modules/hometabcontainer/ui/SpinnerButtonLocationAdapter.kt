...
class SpinnerButtonLocationAdapter(
  private val mContext: Context,
  @LayoutRes
  private val layoutResource: Int,
  private val allItems: List<SpinnerButtonLocationModel>
) : ArrayAdapter<SpinnerButtonLocationModel>(mContext, layoutResource, allItems) {
