package com.housitbuyrentsellproperty.app.modules.login.ui
...
import com.housitbuyrentsellproperty.app.databinding.ActivityLoginBinding
import com.housitbuyrentsellproperty.app.modules.formempty.ui.FormEmptyActivity
import com.housitbuyrentsellproperty.app.modules.login.`data`.viewmodel.LoginVM
    ...
    override fun setUpClicks(): Unit {
      ...
      binding.imageFacebook.setOnClickListener {
        ...
        binding.btnContinueWithEmail.setOnClickListener {
          val destIntent = FormEmptyActivity.getIntent(this, null)
          startActivity(destIntent)
        }
