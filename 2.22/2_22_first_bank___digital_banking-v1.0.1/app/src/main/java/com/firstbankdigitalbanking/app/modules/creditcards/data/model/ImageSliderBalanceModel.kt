...
data class ImageSliderBalanceModel(
  /**
   ...
   * TODO Replace with dynamic value
   */
  var txtFiveThousandSevenHundredFiftyS: String? =
      MyApp.getInstance().resources.getString(R.string.lbl_5_756)
  ,
  /**
   * TODO Replace with dynamic value
   */
