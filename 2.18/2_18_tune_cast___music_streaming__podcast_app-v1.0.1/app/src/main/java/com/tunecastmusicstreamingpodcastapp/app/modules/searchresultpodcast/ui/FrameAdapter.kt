...
import com.tunecastmusicstreamingpodcastapp.app.databinding.RowFrame4Binding
...
class FrameAdapter(
  ...
  inner class RowFrame4VH(
    ...
    init {
      binding.linearPodcastCard.setOnClickListener {
        // TODO replace with value from datasource
        clickListener?.onItemClick(it, adapterPosition, Frame4RowModel())
      }
    }
  }
}
