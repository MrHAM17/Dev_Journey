...
import 'package:the_6_12_street_style___e_commerce_app/widgets/custom_text_form_field.dart';
                ...
                return CarouselSlider.builder(
                    options: CarouselOptions(
                        ...
                        onPageChanged: (index, reason) {
                          ref.watch(paymentNotifier).sliderIndex = index;
                        }),
                    itemCount: ref
                            .watch(paymentNotifier)
                            .paymentModelObj
                            ?.cardItemList
                            .length ??
                        0,
                    itemBuilder: (context, index, realIndex) {
                      CardItemModel model = ref
                              .watch(paymentNotifier)
                              .paymentModelObj
                              ?.cardItemList[index] ??
                          CardItemModel();
                ...
                children: [
                  ...
                  Consumer(builder: (context, ref, _) {
                    return CustomTextFormField(
                        controller:
                            ref.watch(paymentNotifier).applePayController,
