...
import 'package:the_6_12_street_style___e_commerce_app/widgets/custom_elevated_button.dart';
import 'package:the_6_12_street_style___e_commerce_app/widgets/custom_outlined_button.dart';
  ...
  Widget _buildShop(BuildContext context) {
    return Consumer(builder: (context, ref, _) {
      return GridView.builder(
          ...
          itemCount:
              ref.watch(shopNotifier).shopModelObj?.shopItemList.length ?? 0,
          itemBuilder: (context, index) {
            ShopItemModel model =
                ref.watch(shopNotifier).shopModelObj?.shopItemList[index] ??
                    ShopItemModel();
