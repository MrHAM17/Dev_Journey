import 'bloc/my_home_empty_bloc.dart';import 'models/my_home_empty_model.dart';import 'package:flutter/material.dart';import 'package:the_3_21_vertex___real_estate_app/core/app_export.dart';import 'package:the_3_21_vertex___real_estate_app/presentation/home_search_page/home_search_page.dart';import 'package:the_3_21_vertex___real_estate_app/presentation/message_page/message_page.dart';import 'package:the_3_21_vertex___real_estate_app/presentation/my_home_page/my_home_page.dart';import 'package:the_3_21_vertex___real_estate_app/presentation/profile_page/profile_page.dart';import 'package:the_3_21_vertex___real_estate_app/widgets/custom_bottom_bar.dart';import 'package:the_3_21_vertex___real_estate_app/widgets/custom_elevated_button.dart';
// ignore_for_file: must_be_immutable
class MyHomeEmptyScreen extends StatelessWidget {MyHomeEmptyScreen({Key? key}) : super(key: key);

GlobalKey<NavigatorState> navigatorKey = GlobalKey();

static Widget builder(BuildContext context) { return BlocProvider<MyHomeEmptyBloc>(create: (context) => MyHomeEmptyBloc(MyHomeEmptyState(myHomeEmptyModelObj: MyHomeEmptyModel()))..add(MyHomeEmptyInitialEvent()), child: MyHomeEmptyScreen()); } 
@override Widget build(BuildContext context) { return BlocBuilder<MyHomeEmptyBloc, MyHomeEmptyState>(builder: (context, state) {return SafeArea(child: Scaffold(body: Container(width: double.maxFinite, padding: EdgeInsets.symmetric(horizontal: 25.h), child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [SizedBox(height: 7.v), CustomImageView(imagePath: ImageConstant.imgFrame, height: 255.adaptSize, width: 255.adaptSize), SizedBox(height: 63.v), Text("msg_ready_to_sell_your".tr, style: theme.textTheme.titleLarge), SizedBox(height: 6.v), SizedBox(width: 324.h, child: Text("msg_relax_is_making".tr, maxLines: 2, overflow: TextOverflow.ellipsis, textAlign: TextAlign.center, style: theme.textTheme.bodyLarge!.copyWith(height: 1.50))), SizedBox(height: 22.v), CustomElevatedButton(height: 45.v, width: 155.h, text: "lbl_add_proprty".tr, onPressed: () {onTapAddProprty(context);})])), bottomNavigationBar: _buildBottomBar(context)));}); } 
/// Section Widget
