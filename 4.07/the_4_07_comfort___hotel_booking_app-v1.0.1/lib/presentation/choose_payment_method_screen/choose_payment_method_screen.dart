import '../choose_payment_method_screen/widgets/choosepaymentmethod_item_widget.dart';import 'controller/choose_payment_method_controller.dart';import 'models/choosepaymentmethod_item_model.dart';import 'package:flutter/material.dart';import 'package:the_4_07_comfort___hotel_booking_app/core/app_export.dart';import 'package:the_4_07_comfort___hotel_booking_app/widgets/app_bar/appbar_title.dart';import 'package:the_4_07_comfort___hotel_booking_app/widgets/app_bar/custom_app_bar.dart';import 'package:the_4_07_comfort___hotel_booking_app/widgets/custom_elevated_button.dart';class ChoosePaymentMethodScreen extends GetWidget<ChoosePaymentMethodController> {const ChoosePaymentMethodScreen({Key? key}) : super(key: key);

@override Widget build(BuildContext context) { return SafeArea(child: Scaffold(appBar: _buildAppBar(), body: Container(width: double.maxFinite, padding: EdgeInsets.symmetric(horizontal: 24.h, vertical: 28.v), child: Column(children: [_buildAddNewCard(), SizedBox(height: 24.v), _buildChoosePaymentMethod()])), bottomNavigationBar: _buildContinue())); } 
/// Section Widget
