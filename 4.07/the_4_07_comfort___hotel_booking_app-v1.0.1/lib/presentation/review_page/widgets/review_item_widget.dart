...
import 'package:the_4_07_comfort___hotel_booking_app/widgets/custom_elevated_button.dart';
        ...
        children: [
          Row(
            children: [
              Obx(
                () => CustomImageView(
                  imagePath: reviewItemModelObj.jennyWilson!.value,
                  height: 48.adaptSize,
                  width: 48.adaptSize,
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Obx(
                      () => Text(
                        reviewItemModelObj.jennyWilson1!.value,
          ...
          Container(
            ...
            child: Obx(
              () => Text(
                reviewItemModelObj.veryniceandcomfortab!.value,
                maxLines: 2,
