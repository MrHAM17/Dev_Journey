import 'package:the_4_07_comfort___hotel_booking_app/core/app_export.dart';import 'package:the_4_07_comfort___hotel_booking_app/presentation/edit_profile_screen/models/edit_profile_model.dart';import 'package:country_pickers/country.dart';import 'package:country_pickers/utils/utils.dart';import 'package:flutter/material.dart';import 'package:the_4_07_comfort___hotel_booking_app/data/models/me/get_me_resp.dart';import 'package:the_4_07_comfort___hotel_booking_app/data/apiClient/api_client.dart';import 'package:fluttertoast/fluttertoast.dart';/// A controller class for the EditProfileScreen.
///
/// This class manages the state of the EditProfileScreen, including the
/// current editProfileModelObj
class EditProfileController extends GetxController {TextEditingController labelController = TextEditingController();
...
@override void onClose() { super.onClose(); labelController.dispose(); labelController1.dispose(); dateController.dispose(); emailController.dispose(); phoneNumberController.dispose(); } 
...
editProfileModelObj.value.labelController1.value = getMeResp.data!.username!.toString();emailController.text = getMeResp.data!.email!.toString();labelController.text = getMeResp.data!.name!.toString(); } 
