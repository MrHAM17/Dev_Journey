    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          Obx(
            () => CustomImageView(
              imagePath: recentlybookedItemModelObj.martinezCannes!.value,
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                Obx(
                  () => Text(
                    recentlybookedItemModelObj.presidentHotel!.value,
                ...
                Obx(
                  () => Text(
                    recentlybookedItemModelObj.parisFrance!.value,
                ...
                Row(
                  children: [
                    SizedBox(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Obx(
                            () => Text(
                              recentlybookedItemModelObj.fortyEight!.value,
                    ...
                    Padding(
                      ...
                      child: Obx(
                        () => Text(
                          recentlybookedItemModelObj.reviews!.value,
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                Obx(
                  () => Text(
                    recentlybookedItemModelObj.price!.value,
                ...
                Obx(
                  () => Text(
                    recentlybookedItemModelObj.night!.value,
