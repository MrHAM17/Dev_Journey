...
import 'notifier/product_view_notifier.dart';
...
class ProductViewScreenState extends ConsumerState<ProductViewScreen> {
  @override
        ...
        return Wrap(
            ...
            children: List<Widget>.generate(
              ...
              return Frame4ItemWidget(model, onSelectedChipView1: (value) {
                ref
                    .read(productViewNotifier.notifier)
