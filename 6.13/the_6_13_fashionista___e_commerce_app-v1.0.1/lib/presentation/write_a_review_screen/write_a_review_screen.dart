import 'notifier/write_a_review_notifier.dart';
...
class WriteAReviewScreenState extends ConsumerState<WriteAReviewScreen> {
  @override
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      Consumer(builder: (context, ref, _) {
        return CustomTextFormField(
            controller: ref.watch(writeAReviewNotifier).inputFieldsController,
