...
import 'notifier/my_cart_notifier.dart';
...
class MyCartPageState extends ConsumerState<MyCartPage> {
  @override
  ...
  Widget _buildMyCart(BuildContext context) {
    return Consumer(builder: (context, ref, _) {
      return ListView.separated(
          ...
          itemCount:
              ref.watch(myCartNotifier).myCartModelObj?.mycartItemList.length ??
                  0,
          itemBuilder: (context, index) {
            MycartItemModel model = ref
                    .watch(myCartNotifier)
                    .myCartModelObj
