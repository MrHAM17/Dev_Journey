import 'notifier/profile_security_notifier.dart';
...
class ProfileSecurityPageState extends ConsumerState<ProfileSecurityPage>
        ...
        Consumer(
          builder: (context, ref, _) {
            return CustomTextFormField(
              controller: ref.watch(profileSecurityNotifier).passwordController,
      ...
      children: [
        ...
        Consumer(
          builder: (context, ref, _) {
            return CustomTextFormField(
              controller:
                  ref.watch(profileSecurityNotifier).newpasswordController,
              hintText: "lbl_password".tr,
