...
import 'package:the_6_08_shopsie___e_commerce_app/domain/facebookauth/facebook_auth_helper.dart';
import 'package:the_6_08_shopsie___e_commerce_app/domain/googleauth/google_auth_helper.dart';
...
class RegisterScreenState extends ConsumerState<RegisterScreen> {
  ...
  Widget _buildFirstName(BuildContext context) {
    return Consumer(builder: (context, ref, _) {
      return CustomTextFormField(
          controller: ref.watch(registerNotifier).firstNameController,
  ...
  Widget _buildLastName(BuildContext context) {
    return Consumer(builder: (context, ref, _) {
      return CustomTextFormField(
          controller: ref.watch(registerNotifier).lastNameController,
