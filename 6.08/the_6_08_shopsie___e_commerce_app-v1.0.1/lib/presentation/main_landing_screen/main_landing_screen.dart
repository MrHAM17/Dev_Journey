...
import 'notifier/main_landing_notifier.dart';
...
import 'package:the_6_08_shopsie___e_commerce_app/widgets/app_bar/appbar_trailing_image.dart';
import 'package:the_6_08_shopsie___e_commerce_app/widgets/app_bar/custom_app_bar.dart';
import 'package:the_6_08_shopsie___e_commerce_app/widgets/custom_drop_down.dart';
...
class MainLandingScreen extends ConsumerStatefulWidget {
...
class MainLandingScreenState extends ConsumerState<MainLandingScreen> {
            ...
            builder: (context, ref, _) {
              return ListView.separated(
                ...
                itemCount: ref
                    ...
                    0,
                itemBuilder: (context, index) {
                  ThirtytwoItemModel model = ref
                          .watch(mainLandingNotifier)
                          .mainLandingModelObj
                          ?.thirtytwoItemList[index] ??
                      ThirtytwoItemModel();
          ...
          builder: (context, ref, _) {
            return GridView.builder(
              ...
              itemCount: ref
                  ...
                  0,
              itemBuilder: (context, index) {
                MainlandingItemModel model = ref
                        .watch(mainLandingNotifier)
                        .mainLandingModelObj
                    ...
                    builder: (context, ref, _) {
                      return CustomDropDown(
                        ...
                        items: ref
                            ...
                            [],
                        onChanged: (value) {
                          ref.watch(mainLandingNotifier).selectedDropDownValue =
                              value;
                        },
                      );
                    },
                  ...
                  builder: (context, ref, _) {
                    return CustomDropDown(
                      ...
                      items: ref
                          ...
                          [],
                      onChanged: (value) {
                        ref.watch(mainLandingNotifier).selectedDropDownValue2 =
                            value;
                      },
                    );
                  },
              ...
              Consumer(
                builder: (context, ref, _) {
                  return CustomTextFormField(
                    width: 234.h,
                    controller: ref.watch(mainLandingNotifier).emailController,
