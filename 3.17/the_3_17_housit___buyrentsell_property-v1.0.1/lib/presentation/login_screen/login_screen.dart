import 'bloc/login_bloc.dart';import 'models/login_model.dart';import 'package:flutter/material.dart';import 'package:the_3_17_housit___buyrentsell_property/core/app_export.dart';import 'package:the_3_17_housit___buyrentsell_property/widgets/app_bar/appbar_leading_iconbutton_one.dart';import 'package:the_3_17_housit___buyrentsell_property/widgets/app_bar/appbar_trailing_iconbutton_one.dart';import 'package:the_3_17_housit___buyrentsell_property/widgets/app_bar/custom_app_bar.dart';import 'package:the_3_17_housit___buyrentsell_property/widgets/custom_elevated_button.dart';import 'package:the_3_17_housit___buyrentsell_property/domain/googleauth/google_auth_helper.dart';import 'package:the_3_17_housit___buyrentsell_property/domain/facebookauth/facebook_auth_helper.dart';class LoginScreen extends StatelessWidget {const LoginScreen({Key? key}) : super(key: key);
...
@override Widget build(BuildContext context) { return BlocBuilder<LoginBloc, LoginState>(builder: (context, state) {return SafeArea(child: Scaffold(body: SizedBox(width: 355.h, child: Column(children: [SizedBox(height: 416.v, width: 355.h, child: Stack(alignment: Alignment.topCenter, children: [CustomImageView(imagePath: ImageConstant.imgBackgroundIllustration416x355, height: 416.v, width: 355.h, alignment: Alignment.center), _buildAppBar(context)])), SizedBox(height: 33.v), Align(alignment: Alignment.centerLeft, child: Padding(padding: EdgeInsets.only(left: 14.h), child: Text("msg_ready_to_explore".tr, style: theme.textTheme.headlineSmall))), SizedBox(height: 42.v), CustomElevatedButton(text: "msg_continue_with_email".tr, margin: EdgeInsets.symmetric(horizontal: 14.h), leftIcon: Container(margin: EdgeInsets.only(right: 10.h), child: CustomImageView(imagePath: ImageConstant.imgArrowdown, height: 20.adaptSize, width: 20.adaptSize)), onPressed: () {onTapContinueWithEmail(context);}), SizedBox(height: 18.v), _buildItemSeparator(context), SizedBox(height: 18.v), _buildGoogle(context)])), bottomNavigationBar: _buildSeventySeven(context)));}); } 
/// Section Widget
