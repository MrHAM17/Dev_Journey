...
class SpinnerUnitedEstateAdapter(
  private val mContext: Context,
  @LayoutRes
  private val layoutResource: Int,
  private val allItems: List<SpinnerUnitedEstateModel>
) : ArrayAdapter<SpinnerUnitedEstateModel>(mContext, layoutResource, allItems) {
