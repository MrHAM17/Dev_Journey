...
class MyCartScreen extends StatelessWidget {
  ...
  Widget _buildPaymentDetail(BuildContext context) {
    return Column(children: [
      ...
      Padding(
          ...
          child: _buildTotal(context, total: "Subtotal", price: "25.98")),
      SizedBox(height: 11.v),
      Padding(
          padding: EdgeInsets.only(right: 1.h),
          child: _buildCard(context, vISA: "Taxes", change: "1.00")),
      SizedBox(height: 11.v),
      Padding(
          padding: EdgeInsets.only(right: 4.h),
          child: _buildTotal(context, total: "Total", price: "26.98"))
    ]);
  }
  ...
  Widget _buildPaymentMethod(BuildContext context) {
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      Padding(
          padding: EdgeInsets.only(left: 1.h),
          child: _buildCard(context, vISA: "VISA", change: "Change"))
    ]);
  }
