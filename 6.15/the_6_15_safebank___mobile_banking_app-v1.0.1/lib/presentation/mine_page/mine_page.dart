...
import 'notifier/mine_notifier.dart';
import 'package:flutter/material.dart';
import 'package:the_6_15_safebank___mobile_banking_app/core/app_export.dart';
import 'package:the_6_15_safebank___mobile_banking_app/widgets/app_bar/appbar_trailing_circleimage.dart';
    ...
    return Column(children: [
      ...
      Consumer(builder: (context, ref, _) {
        return ListView.separated(
            ...
            itemCount:
                ref.watch(mineNotifier).mineModelObj?.fifteenItemList.length ??
                    0,
            itemBuilder: (context, index) {
              FifteenItemModel model = ref
                      .watch(mineNotifier)
                      .mineModelObj
                      ?.fifteenItemList[index] ??
                  FifteenItemModel();
