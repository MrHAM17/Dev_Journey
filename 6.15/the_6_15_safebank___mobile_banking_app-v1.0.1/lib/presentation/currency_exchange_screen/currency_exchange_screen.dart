...
import 'notifier/currency_exchange_notifier.dart';
...
import 'package:the_6_15_safebank___mobile_banking_app/widgets/app_bar/appbar_trailing_iconbutton_one.dart';
...
import 'package:the_6_15_safebank___mobile_banking_app/widgets/custom_outlined_button.dart';
...
class CurrencyExchangeScreenState
                      ...
                      children: [
                        ...
                        Consumer(builder: (context, ref, _) {
                          return CustomDropDown(
                              ...
                              items: ref
                                      .watch(currencyExchangeNotifier)
  ...
  Widget _buildComment(BuildContext context) {
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      Consumer(builder: (context, ref, _) {
        return CustomTextFormField(
            controller: ref.watch(currencyExchangeNotifier).commentController,
