...
import 'package:the_6_15_safebank___mobile_banking_app/widgets/custom_switch.dart';
    ...
    return Row(mainAxisAlignment: MainAxisAlignment.center, children: [
      ...
      Consumer(builder: (context, ref, _) {
        return CustomSwitch(
            ...
            value: ref.watch(settingsNotifier).isSelectedSwitch,
            onChange: (value) {
              ref.read(settingsNotifier.notifier).changeSwitchBox1(value);
            });
      })
    ]);
  }
