...
import 'package:the_6_15_safebank___mobile_banking_app/presentation/profile_page/models/profile_model.dart';
part 'profile_state.dart';

final profileNotifier = StateNotifierProvider<ProfileNotifier, ProfileState>(
    (ref) => ProfileNotifier(ProfileState(
        isSelectedSwitch: false, profileModelObj: ProfileModel())));
