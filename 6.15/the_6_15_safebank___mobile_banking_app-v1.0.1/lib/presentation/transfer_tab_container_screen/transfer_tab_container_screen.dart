...
import 'notifier/transfer_tab_container_notifier.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg_provider/flutter_svg_provider.dart' as fs;
import 'package:the_6_15_safebank___mobile_banking_app/core/app_export.dart';
import 'package:the_6_15_safebank___mobile_banking_app/presentation/transfer_page/transfer_page.dart';
...
class TransferTabContainerScreen extends ConsumerStatefulWidget {
...
class TransferTabContainerScreenState
    extends ConsumerState<TransferTabContainerScreen>
        ...
        child: SizedBox(
            ...
            child: Consumer(builder: (context, ref, _) {
              return ListView.separated(
                  ...
                  itemCount: ref
                          .watch(transferTabContainerNotifier)
                          .transferTabContainerModelObj
                          ?.transfertabcontainerItemList
                          .length ??
                      0,
                  itemBuilder: (context, index) {
                    TransfertabcontainerItemModel model = ref
                            .watch(transferTabContainerNotifier)
                            .transferTabContainerModelObj
