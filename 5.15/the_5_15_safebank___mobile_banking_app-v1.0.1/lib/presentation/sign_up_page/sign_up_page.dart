...
import 'package:the_5_15_safebank___mobile_banking_app/core/utils/validation_functions.dart';
...
import 'package:the_5_15_safebank___mobile_banking_app/widgets/custom_floating_text_field.dart';
...
class SignUpPage extends StatefulWidget {
  ...
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
        create: (context) => SignUpProvider(), child: SignUpPage());
  }
}
  ...
  Widget _buildJan(BuildContext context) {
    return Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
      SizedBox(
          ...
          width: 155.h,
          child: Stack(alignment: Alignment.topLeft, children: [
            Selector<SignUpProvider, SignUpModel?>(
                selector: (context, provider) => provider.signUpModelObj,
                builder: (context, signUpModelObj, child) {
                  return CustomDropDown(
                      ...
                      onChanged: (value) {
                        context.read<SignUpProvider>().onSelected(value);
                      });
                }),
            Align(
                alignment: Alignment.topLeft,
        ...
        Selector<SignUpProvider, SignUpModel?>(
            ...
            builder: (context, signUpModelObj, child) {
              return CustomDropDown(
                  ...
                  onChanged: (value) {
                    context.read<SignUpProvider>().onSelected1(value);
                  });
            })
      ])
    ]);
