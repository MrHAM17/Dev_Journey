...
import 'notifier/explore_eight_notifier.dart';
...
class ExploreEightPage extends ConsumerStatefulWidget {
...
class ExploreEightPageState extends ConsumerState<ExploreEightPage> {
  @override
    ...
    return SizedBox(
        ...
        child: Consumer(builder: (context, ref, _) {
          return ListView.separated(
              ...
              itemCount: ref
                      .watch(exploreEightNotifier)
                      .exploreEightModelObj
                      ?.specials7ItemList
                      .length ??
                  0,
              itemBuilder: (context, index) {
                Specials7ItemModel model = ref
                        .watch(exploreEightNotifier)
                        .exploreEightModelObj
                        ?.specials7ItemList[index] ??
                    Specials7ItemModel();
    ...
    return Consumer(builder: (context, ref, _) {
      return GridView.builder(
          ...
          itemCount: ref
              ...
              0,
          itemBuilder: (context, index) {
            ExploreeightItemModel model = ref
                    .watch(exploreEightNotifier)
                    .exploreEightModelObj
                    ?.exploreeightItemList[index] ??
