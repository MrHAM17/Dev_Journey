...
import 'notifier/detail_page_eight_notifier.dart';
...
class DetailPageEightScreen extends ConsumerStatefulWidget {
...
class DetailPageEightScreenState extends ConsumerState<DetailPageEightScreen> {
  @override
    ...
    return SizedBox(
        ...
        child: Consumer(builder: (context, ref, _) {
          return ListView.separated(
              ...
              itemCount: ref
                      .watch(detailPageEightNotifier)
                      .detailPageEightModelObj
                      ?.movies5ItemList
                      .length ??
                  0,
              itemBuilder: (context, index) {
                Movies5ItemModel model = ref
                        .watch(detailPageEightNotifier)
                        .detailPageEightModelObj
