...
import 'notifier/detail_page_twelve_notifier.dart';
...
class DetailPageTwelveScreen extends ConsumerStatefulWidget {
...
class DetailPageTwelveScreenState
    extends ConsumerState<DetailPageTwelveScreen> {
  @override
    ...
    return SizedBox(
        ...
        child: Consumer(builder: (context, ref, _) {
          return ListView.separated(
              ...
              itemCount: ref
                      .watch(detailPageTwelveNotifier)
                      .detailPageTwelveModelObj
                      ?.movies4ItemList
                      .length ??
                  0,
              itemBuilder: (context, index) {
                Movies4ItemModel model = ref
                        .watch(detailPageTwelveNotifier)
                        .detailPageTwelveModelObj
