...
import 'notifier/detail_page_eleven_notifier.dart';
...
class DetailPageElevenScreen extends ConsumerStatefulWidget {
...
class DetailPageElevenScreenState
    extends ConsumerState<DetailPageElevenScreen> {
  @override
    ...
    return SizedBox(
        ...
        child: Consumer(builder: (context, ref, _) {
          return ListView.separated(
              ...
              itemCount: ref
                      .watch(detailPageElevenNotifier)
                      .detailPageElevenModelObj
                      ?.movies3ItemList
                      .length ??
                  0,
              itemBuilder: (context, index) {
                Movies3ItemModel model = ref
                        .watch(detailPageElevenNotifier)
                        .detailPageElevenModelObj
