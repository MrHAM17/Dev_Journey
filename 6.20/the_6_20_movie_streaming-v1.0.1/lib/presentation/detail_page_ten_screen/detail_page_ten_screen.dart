...
import 'notifier/detail_page_ten_notifier.dart';
...
class DetailPageTenScreen extends ConsumerStatefulWidget {
...
class DetailPageTenScreenState extends ConsumerState<DetailPageTenScreen> {
  @override
    ...
    return SizedBox(
        ...
        child: Consumer(builder: (context, ref, _) {
          return ListView.separated(
              ...
              itemCount: ref
                      .watch(detailPageTenNotifier)
                      .detailPageTenModelObj
                      ?.movies2ItemList
                      .length ??
                  0,
              itemBuilder: (context, index) {
                Movies2ItemModel model = ref
                        .watch(detailPageTenNotifier)
                        .detailPageTenModelObj
