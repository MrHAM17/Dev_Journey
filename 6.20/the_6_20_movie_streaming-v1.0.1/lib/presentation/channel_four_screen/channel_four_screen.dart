...
import 'notifier/channel_four_notifier.dart';
...
class ChannelFourScreen extends ConsumerStatefulWidget {
...
class ChannelFourScreenState extends ConsumerState<ChannelFourScreen> {
  @override
    ...
    return Padding(
        ...
        child: Consumer(builder: (context, ref, _) {
          return ListView.separated(
              ...
              itemCount: ref
                      .watch(channelFourNotifier)
                      .channelFourModelObj
                      ?.channelfourItemList
                      .length ??
                  0,
              itemBuilder: (context, index) {
                ChannelfourItemModel model = ref
                        .watch(channelFourNotifier)
                        .channelFourModelObj
