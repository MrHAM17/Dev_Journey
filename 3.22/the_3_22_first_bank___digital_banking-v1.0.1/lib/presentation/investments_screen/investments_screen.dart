...
class InvestmentsScreen extends StatelessWidget {
  ...
  Widget _buildMoneyBagOfDollars(BuildContext context) {
    return BlocSelector<InvestmentsBloc, InvestmentsState, InvestmentsModel?>(
      ...
      builder: (context, investmentsModelObj) {
        return ListView.separated(
          ...
          itemCount: investmentsModelObj?.moneybagofdollarsItemList.length ?? 0,
          itemBuilder: (context, index) {
            MoneybagofdollarsItemModel model =
                investmentsModelObj?.moneybagofdollarsItemList[index] ??
  ...
  Widget _buildMyInvestment(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        BlocSelector<InvestmentsBloc, InvestmentsState, InvestmentsModel?>(
          selector: (state) => state.investmentsModelObj,
          builder: (context, investmentsModelObj) {
            return ListView.separated(
              physics: NeverScrollableScrollPhysics(),
              ...
              itemCount: investmentsModelObj?.applestoreItemList.length ?? 0,
              itemBuilder: (context, index) {
                ApplestoreItemModel model =
                    investmentsModelObj?.applestoreItemList[index] ??
                        ApplestoreItemModel();
