...
class AccountsScreen extends StatelessWidget {
    ...
    return Container(
        ...
        child: Column(children: [
          ...
          Padding(
              ...
              child: BlocSelector<AccountsBloc, AccountsState,
  ...
  Widget _buildAccounts(BuildContext context) {
    return BlocSelector<AccountsBloc, AccountsState, AccountsModel?>(
        ...
        builder: (context, accountsModelObj) {
          return GridView.builder(
              ...
              itemCount: accountsModelObj?.accountsItemList.length ?? 0,
              itemBuilder: (context, index) {
                AccountsItemModel model =
                    accountsModelObj?.accountsItemList[index] ??
                        AccountsItemModel();
