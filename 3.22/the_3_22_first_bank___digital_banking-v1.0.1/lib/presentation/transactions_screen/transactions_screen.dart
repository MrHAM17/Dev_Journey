  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<TransactionsBloc>(
        create: (context) => TransactionsBloc(
            TransactionsState(transactionsModelObj: TransactionsModel()))
        ...
        child: BlocSelector<TransactionsBloc, TransactionsState,
            ...
            builder: (context, transactionsModelObj) {
              return ListView.separated(
                  ...
                  itemCount: transactionsModelObj?.balance1ItemList.length ?? 0,
                  itemBuilder: (context, index) {
                    Balance1ItemModel model =
                        transactionsModelObj?.balance1ItemList[index] ??
                            Balance1ItemModel();
        ...
        child: BlocSelector<TransactionsBloc, TransactionsState,
            ...
            builder: (context, transactionsModelObj) {
              return ListView.separated(
                  ...
                  itemCount: transactionsModelObj?.arrowItemList.length ?? 0,
                  itemBuilder: (context, index) {
                    ArrowItemModel model =
                        transactionsModelObj?.arrowItemList[index] ??
                            ArrowItemModel();
