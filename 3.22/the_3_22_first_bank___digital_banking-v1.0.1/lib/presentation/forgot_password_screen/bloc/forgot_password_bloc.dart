...
import 'package:the_3_22_first_bank___digital_banking/presentation/forgot_password_screen/models/forgot_password_model.dart';
...
class ForgotPasswordBloc
  ...
  _onInitialize(
    ...
    emit(state.copyWith(newpasswordController: TextEditingController()));
