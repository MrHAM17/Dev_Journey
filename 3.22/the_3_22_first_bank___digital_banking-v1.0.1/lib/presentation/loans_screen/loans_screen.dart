      ...
      child: Column(
        children: [
          ...
          Padding(
            ...
            child: BlocSelector<LoansBloc, LoansState, TextEditingController?>(
      ...
      child: BlocSelector<LoansBloc, LoansState, LoansModel?>(
        ...
        builder: (context, loansModelObj) {
          return ListView.separated(
            ...
            itemCount: loansModelObj?.loansItemList.length ?? 0,
            itemBuilder: (context, index) {
              LoansItemModel model =
                  loansModelObj?.loansItemList[index] ?? LoansItemModel();
