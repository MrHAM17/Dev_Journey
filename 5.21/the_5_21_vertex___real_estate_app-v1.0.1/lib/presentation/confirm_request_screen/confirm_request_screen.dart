import 'models/confirm_request_model.dart';import 'package:flutter/material.dart';import 'package:the_5_21_vertex___real_estate_app/core/app_export.dart';import 'package:the_5_21_vertex___real_estate_app/widgets/app_bar/appbar_leading_iconbutton.dart';import 'package:the_5_21_vertex___real_estate_app/widgets/app_bar/custom_app_bar.dart';import 'package:the_5_21_vertex___real_estate_app/widgets/custom_elevated_button.dart';import 'package:the_5_21_vertex___real_estate_app/widgets/custom_icon_button.dart';import 'provider/confirm_request_provider.dart';import 'package:the_5_21_vertex___real_estate_app/presentation/confirm_request_bottom_sheet_bottomsheet/confirm_request_bottom_sheet_bottomsheet.dart';class ConfirmRequestScreen extends StatefulWidget {const ConfirmRequestScreen({Key? key}) : super(key: key);
...
/// [BuildContext] object.
onTapDone(BuildContext context) { showModalBottomSheet(context: context, builder: (_)=>ConfirmRequestBottomSheetBottomsheet.builder(context),isScrollControlled: true); } 
 }
