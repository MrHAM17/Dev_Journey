import '../my_home_page/widgets/list_item_widget.dart';import 'models/list_item_model.dart';import 'models/my_home_model.dart';import 'package:flutter/material.dart';import 'package:the_5_21_vertex___real_estate_app/core/app_export.dart';import 'package:the_5_21_vertex___real_estate_app/widgets/app_bar/appbar_leading_iconbutton.dart';import 'package:the_5_21_vertex___real_estate_app/widgets/app_bar/appbar_subtitle_two.dart';import 'package:the_5_21_vertex___real_estate_app/widgets/app_bar/custom_app_bar.dart';import 'package:the_5_21_vertex___real_estate_app/widgets/custom_outlined_button.dart';import 'provider/my_home_provider.dart';class MyHomePage extends StatefulWidget {const MyHomePage({Key? key}) : super(key: key);
...
/// Section Widget
Widget _buildList(BuildContext context) { return Consumer<MyHomeProvider>(builder: (context, provider, child) {return ListView.separated(physics: NeverScrollableScrollPhysics(), shrinkWrap: true, separatorBuilder: (context, index) {return SizedBox(height: 16.v);}, itemCount: provider.myHomeModelObj.listItemList.length, itemBuilder: (context, index) {ListItemModel model = provider.myHomeModelObj.listItemList[index]; return ListItemWidget(model, onTapProperty: () {onTapProperty(context);});});}); } 
