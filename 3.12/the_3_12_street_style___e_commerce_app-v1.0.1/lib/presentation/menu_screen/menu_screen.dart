...
import 'package:the_3_12_street_style___e_commerce_app/widgets/app_bar/appbar_leading_circleimage.dart';
import 'package:the_3_12_street_style___e_commerce_app/widgets/app_bar/appbar_subtitle.dart';
import 'package:the_3_12_street_style___e_commerce_app/widgets/app_bar/appbar_subtitle_one.dart';
...
class MenuScreen extends StatelessWidget {
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<MenuBloc>(
        create: (context) => MenuBloc(MenuState(menuModelObj: MenuModel()))
      ...
      return SafeArea(
          child: Scaffold(
              ...
              body: Container(
                  ...
                  padding:
                      EdgeInsets.symmetric(horizontal: 37.h, vertical: 20.v),
                  child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(
                            width: 138.h,
                            child:
                                Divider(color: appTheme.gray700, indent: 1.h)),
