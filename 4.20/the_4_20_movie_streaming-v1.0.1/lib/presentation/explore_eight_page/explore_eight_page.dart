...
class ExploreEightPage extends StatelessWidget {
    ...
    return SizedBox(
        ...
        child: Obx(() => ListView.separated(
            ...
            itemCount: controller
                .exploreEightModelObj.value.specials7ItemList.value.length,
            itemBuilder: (context, index) {
              Specials7ItemModel model = controller
                  .exploreEightModelObj.value.specials7ItemList.value[index];
  ...
  Widget _buildExploreEight() {
    return Obx(() => GridView.builder(
        ...
        itemCount: controller
            .exploreEightModelObj.value.exploreeightItemList.value.length,
        itemBuilder: (context, index) {
          ExploreeightItemModel model = controller
              .exploreEightModelObj.value.exploreeightItemList.value[index];
