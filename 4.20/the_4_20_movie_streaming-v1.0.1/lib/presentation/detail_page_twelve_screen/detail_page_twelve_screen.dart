...
import 'package:the_4_20_movie_streaming/widgets/custom_elevated_button.dart';
import 'package:the_4_20_movie_streaming/widgets/custom_icon_button.dart';
    ...
    return SizedBox(
        ...
        child: Obx(() => ListView.separated(
            ...
            itemCount: controller
                .detailPageTwelveModelObj.value.movies4ItemList.value.length,
            itemBuilder: (context, index) {
              Movies4ItemModel model = controller
                  .detailPageTwelveModelObj.value.movies4ItemList.value[index];
