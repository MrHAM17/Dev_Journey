...
import 'package:the_4_20_movie_streaming/widgets/app_bar/appbar_title_searchview.dart';
    ...
    return SizedBox(
        ...
        child: Obx(() => ListView.separated(
            ...
            itemCount: controller
                .exploreNineModelObj.value.specials8ItemList.value.length,
            itemBuilder: (context, index) {
              Specials8ItemModel model = controller
                  .exploreNineModelObj.value.specials8ItemList.value[index];
