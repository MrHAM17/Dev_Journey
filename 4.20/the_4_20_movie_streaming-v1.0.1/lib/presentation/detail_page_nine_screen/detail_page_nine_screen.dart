  ...
  Widget _buildFrameFiftyThree() {
    return Obx(() => Wrap(
        ...
        children: List<Widget>.generate(
            controller.detailPageNineModelObj.value.framefiftythreeItemList
                .value.length, (index) {
          FramefiftythreeItemModel model = controller.detailPageNineModelObj
              .value.framefiftythreeItemList.value[index];
