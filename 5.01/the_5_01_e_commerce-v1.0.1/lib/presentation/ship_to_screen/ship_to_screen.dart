import '../ship_to_screen/widgets/shipto_item_widget.dart';import 'models/ship_to_model.dart';import 'models/shipto_item_model.dart';import 'package:flutter/material.dart';import 'package:the_5_01_e_commerce/core/app_export.dart';import 'package:the_5_01_e_commerce/widgets/app_bar/appbar_leading_image.dart';import 'package:the_5_01_e_commerce/widgets/app_bar/appbar_subtitle.dart';import 'package:the_5_01_e_commerce/widgets/app_bar/appbar_trailing_image.dart';import 'package:the_5_01_e_commerce/widgets/app_bar/custom_app_bar.dart';import 'package:the_5_01_e_commerce/widgets/custom_elevated_button.dart';import 'provider/ship_to_provider.dart';class ShipToScreen extends StatefulWidget {const ShipToScreen({Key? key}) : super(key: key);
...
/// Section Widget
Widget _buildShipTo(BuildContext context) { return Expanded(child: Padding(padding: EdgeInsets.symmetric(horizontal: 16.h), child: Consumer<ShipToProvider>(builder: (context, provider, child) {return ListView.separated(physics: BouncingScrollPhysics(), shrinkWrap: true, separatorBuilder: (context, index) {return SizedBox(height: 22.v);}, itemCount: provider.shipToModelObj.shiptoItemList.length, itemBuilder: (context, index) {ShiptoItemModel model = provider.shipToModelObj.shiptoItemList[index]; return ShiptoItemWidget(model);});}))); } 
/// Section Widget
