...
import 'provider/mobile_prepaid_three_provider.dart';

class MobilePrepaidThreeScreen extends StatefulWidget {
  ...
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
        create: (context) => MobilePrepaidThreeProvider(),
        child: MobilePrepaidThreeScreen());
  }
}

class MobilePrepaidThreeScreenState extends State<MobilePrepaidThreeScreen> {
  @override
  void initState() {
    super.initState();
            ...
            body: Container(
                ...
                child: Column(children: [
                  ...
                  Padding(
                      ...
                      child: Selector<MobilePrepaidThreeProvider,
