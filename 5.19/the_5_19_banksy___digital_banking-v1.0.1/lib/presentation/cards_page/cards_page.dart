...
class CardsPage extends StatefulWidget {
  ...
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
        create: (context) => CardsProvider(), child: CardsPage());
  }
}
...
class CardsPageState extends State<CardsPage> {
  ...
  Widget _buildCards(BuildContext context) {
    return Padding(
        ...
        child: Consumer<CardsProvider>(builder: (context, provider, child) {
          return ListView.separated(
              ...
              itemCount: provider.cardsModelObj.cardsItemList.length,
              itemBuilder: (context, index) {
                CardsItemModel model =
                    provider.cardsModelObj.cardsItemList[index];
