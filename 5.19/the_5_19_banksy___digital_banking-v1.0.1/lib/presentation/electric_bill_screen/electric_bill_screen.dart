...
import 'provider/electric_bill_provider.dart';
...
class ElectricBillScreen extends StatefulWidget {
  ...
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
        create: (context) => ElectricBillProvider(),
        child: ElectricBillScreen());
  }
}

// ignore_for_file: must_be_immutable
class ElectricBillScreenState extends State<ElectricBillScreen> {
  ...
  Widget _buildInputField(BuildContext context) {
    return Padding(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          SizedBox(height: 11.v),
          Selector<ElectricBillProvider, TextEditingController?>(
  ...
  Widget _buildInputField5(BuildContext context) {
    return Padding(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          SizedBox(height: 11.v),
          Selector<ElectricBillProvider, TextEditingController?>(
              selector: (context, provider) => provider.dateController1,
  ...
  Widget _buildElectricBill(BuildContext context) {
    return SizedBox(
        height: 180.v,
        child:
            Consumer<ElectricBillProvider>(builder: (context, provider, child) {
          return ListView.separated(
              ...
              itemCount:
                  provider.electricBillModelObj.electricbillItemList.length,
              itemBuilder: (context, index) {
                ElectricbillItemModel model =
                    provider.electricBillModelObj.electricbillItemList[index];
