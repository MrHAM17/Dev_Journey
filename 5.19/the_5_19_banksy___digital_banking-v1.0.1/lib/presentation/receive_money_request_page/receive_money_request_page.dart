...
import 'provider/receive_money_request_provider.dart';
...
class ReceiveMoneyRequestPage extends StatefulWidget {
  ...
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
        create: (context) => ReceiveMoneyRequestProvider(),
  ...
  Widget _buildInputField(BuildContext context) {
    return Padding(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Selector<ReceiveMoneyRequestProvider, TextEditingController?>(
