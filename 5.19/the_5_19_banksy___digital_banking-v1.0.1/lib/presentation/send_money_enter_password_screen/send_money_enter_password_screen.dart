...
import 'package:the_5_19_banksy___digital_banking/widgets/custom_pin_code_text_field.dart';
import 'provider/send_money_enter_password_provider.dart';

class SendMoneyEnterPasswordScreen extends StatefulWidget {
  const SendMoneyEnterPasswordScreen({Key? key}) : super(key: key);

  @override
  SendMoneyEnterPasswordScreenState createState() =>
      SendMoneyEnterPasswordScreenState();

  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
        create: (context) => SendMoneyEnterPasswordProvider(),
        child: SendMoneyEnterPasswordScreen());
  }
}

class SendMoneyEnterPasswordScreenState
    extends State<SendMoneyEnterPasswordScreen> {
  @override
  void initState() {
            ...
            body: Container(
                ...
                child: Column(children: [
                  ...
                  Padding(
                      ...
                      child: Selector<SendMoneyEnterPasswordProvider,
