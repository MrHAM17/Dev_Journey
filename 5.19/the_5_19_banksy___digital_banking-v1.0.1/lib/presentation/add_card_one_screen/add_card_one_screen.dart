...
import 'provider/add_card_one_provider.dart';
...
class AddCardOneScreen extends StatefulWidget {
  ...
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
        create: (context) => AddCardOneProvider(), child: AddCardOneScreen());
  }
}

// ignore_for_file: must_be_immutable
class AddCardOneScreenState extends State<AddCardOneScreen> {
  ...
  Widget _buildInputField(BuildContext context) {
    return Padding(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Selector<AddCardOneProvider, TextEditingController?>(
  ...
  Widget _buildSaveMyCardDetails(BuildContext context) {
    return Align(
        ...
        child: Padding(
            ...
            child: Selector<AddCardOneProvider, bool?>(
                selector: (context, provider) => provider.saveMyCardDetails,
                builder: (context, saveMyCardDetails, child) {
