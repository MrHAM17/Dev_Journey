...
import 'provider/enter_money_provider.dart';

class EnterMoneyScreen extends StatefulWidget {
  const EnterMoneyScreen({Key? key}) : super(key: key);

  @override
  EnterMoneyScreenState createState() => EnterMoneyScreenState();

  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
        create: (context) => EnterMoneyProvider(), child: EnterMoneyScreen());
  }
}

class EnterMoneyScreenState extends State<EnterMoneyScreen> {
  @override
  void initState() {
    super.initState();
  }
            ...
            body: Container(
                ...
                child: Column(children: [
                  ...
                  Padding(
                      ...
                      child:
                          Selector<EnterMoneyProvider, TextEditingController?>(
