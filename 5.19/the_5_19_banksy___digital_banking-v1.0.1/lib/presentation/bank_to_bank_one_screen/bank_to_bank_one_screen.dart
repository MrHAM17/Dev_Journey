...
import 'provider/bank_to_bank_one_provider.dart';

class BankToBankOneScreen extends StatefulWidget {
  const BankToBankOneScreen({Key? key}) : super(key: key);

  @override
  BankToBankOneScreenState createState() => BankToBankOneScreenState();

  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
        create: (context) => BankToBankOneProvider(),
        child: BankToBankOneScreen());
  }
}

class BankToBankOneScreenState extends State<BankToBankOneScreen> {
  @override
  void initState() {
    super.initState();
  }
