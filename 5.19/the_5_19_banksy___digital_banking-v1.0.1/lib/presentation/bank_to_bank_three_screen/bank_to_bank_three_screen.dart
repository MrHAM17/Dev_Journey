...
import 'provider/bank_to_bank_three_provider.dart';

class BankToBankThreeScreen extends StatefulWidget {
  ...
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
        create: (context) => BankToBankThreeProvider(),
        child: BankToBankThreeScreen());
  }
}

class BankToBankThreeScreenState extends State<BankToBankThreeScreen> {
  @override
  void initState() {
    super.initState();
            ...
            body: Container(
                ...
                child: Column(children: [
                  ...
                  Padding(
                      ...
                      child: Selector<BankToBankThreeProvider,
