...
import 'package:the_5_07_comfort___hotel_booking_app/presentation/search_type_page/search_type_page.dart';
import 'package:the_5_07_comfort___hotel_booking_app/widgets/custom_search_view.dart';
import 'provider/search_type_tab_container_provider.dart';
...
class SearchTypeTabContainerScreen extends StatefulWidget {
  ...
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => SearchTypeTabContainerProvider(),
          ...
          child: Column(
            children: [
              ...
              Padding(
                ...
                child: Selector<SearchTypeTabContainerProvider,
