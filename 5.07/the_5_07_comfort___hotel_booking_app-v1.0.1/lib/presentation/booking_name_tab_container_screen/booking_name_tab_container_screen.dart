import 'models/booking_name_tab_container_model.dart';import 'package:flutter/material.dart';import 'package:the_5_07_comfort___hotel_booking_app/core/app_export.dart';import 'package:the_5_07_comfort___hotel_booking_app/presentation/booking_name_page/booking_name_page.dart';import 'package:the_5_07_comfort___hotel_booking_app/widgets/app_bar/appbar_leading_image.dart';import 'package:the_5_07_comfort___hotel_booking_app/widgets/app_bar/appbar_title.dart';import 'package:the_5_07_comfort___hotel_booking_app/widgets/app_bar/custom_app_bar.dart';import 'provider/booking_name_tab_container_provider.dart';class BookingNameTabContainerScreen extends StatefulWidget {const BookingNameTabContainerScreen({Key? key}) : super(key: key);

@override BookingNameTabContainerScreenState createState() =>  BookingNameTabContainerScreenState();

static Widget builder(BuildContext context) { return ChangeNotifierProvider(create: (context) => BookingNameTabContainerProvider(), child: BookingNameTabContainerScreen()); } 
 }
