...
import 'package:the_5_07_comfort___hotel_booking_app/presentation/filter_result_page/filter_result_page.dart';
import 'package:the_5_07_comfort___hotel_booking_app/widgets/custom_search_view.dart';
import 'provider/search_page_tab_container_provider.dart';
...
class SearchPageTabContainerPage extends StatefulWidget {
  ...
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => SearchPageTabContainerProvider(),
          ...
          child: Column(
            children: [
              ...
              Padding(
                ...
                child: Selector<SearchPageTabContainerProvider,
