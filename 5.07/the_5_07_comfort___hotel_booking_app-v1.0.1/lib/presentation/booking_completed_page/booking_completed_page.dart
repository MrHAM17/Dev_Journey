...
import 'provider/booking_completed_provider.dart';
...
class BookingCompletedPage extends StatefulWidget {
  ...
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => BookingCompletedProvider(),
...
class BookingCompletedPageState extends State<BookingCompletedPage> {
  ...
  Widget _buildTickets(BuildContext context) {
    return Consumer<BookingCompletedProvider>(
      builder: (context, provider, child) {
        return ListView.separated(
          ...
          itemCount: provider.bookingCompletedModelObj.ticketsItemList.length,
          itemBuilder: (context, index) {
            TicketsItemModel model =
                provider.bookingCompletedModelObj.ticketsItemList[index];
