              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                        ...
                        Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              Obx(
                                () => Text(
                                  eightyeightItemModelObj
                                      .digitalMarketing!.value,
                              ...
                              Obx(
                                () => Text(
                                  eightyeightItemModelObj.motorola!.value,
                    ...
                    Obx(
                      () => Text(
                        eightyeightItemModelObj.price!.value,
                    ...
                    Obx(
                      () => Wrap(
                        ...
                        children: List<Widget>.generate(
                          controller.eightyeightItemModelObj.value
                              .fulltime3ItemList.value.length,
                          (index) {
                            Fulltime3ItemModel model = controller
                                .eightyeightItemModelObj
                                .value
                                .fulltime3ItemList
                                .value[index];
