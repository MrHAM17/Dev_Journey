...
import 'package:the_4_11_hired___job_search/widgets/custom_radio_button.dart';
        ...
        children: [
          ...
          Padding(
            ...
            child: CustomRadioButton(
              ...
              value:
                  controller.selectACountryModelObj.value.radioList.value[13],
              groupValue: controller.radioGroup.value,
              onChange: (value) {
                controller.radioGroup.value = value;
              },
          ...
          Padding(
            ...
            child: CustomRadioButton(
              text: "lbl_azerbaijan".tr,
              value:
                  controller.selectACountryModelObj.value.radioList.value[14],
              groupValue: controller.radioGroup.value,
              onChange: (value) {
                controller.radioGroup.value = value;
              },
