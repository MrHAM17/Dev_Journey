...
class ProfileModel {
  Rx<List<FortysevenItemModel>> fortysevenItemList =
      Rx(List.generate(8, (index) => FortysevenItemModel()));

  Rx<List<ProfileItemModel>> profileItemList = Rx([
    ProfileItemModel(
        image: ImageConstant.imgLogoDeepOrange700.obs,
        bag: ImageConstant.imgBag.obs,
        internshipUIUX: "Internship UI/UX Designer".obs,
        smallLabelRegular: "Shopee Sg".obs,
        smallLabelRegular1: "•".obs,
        zipcode: "2019".obs)
  ]);
}
