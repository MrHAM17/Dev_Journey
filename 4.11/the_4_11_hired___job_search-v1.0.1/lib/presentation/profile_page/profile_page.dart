        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          Obx(() => Wrap(
              ...
              children: List<Widget>.generate(
                  controller.profileModelObj.value.fortysevenItemList.value
                      .length, (index) {
                FortysevenItemModel model = controller
                    .profileModelObj.value.fortysevenItemList.value[index];
