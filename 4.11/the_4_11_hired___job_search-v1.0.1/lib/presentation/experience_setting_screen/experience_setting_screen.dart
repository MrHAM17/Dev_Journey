  ...
  Widget build(BuildContext context) {
    return SafeArea(
        child: Scaffold(
            ...
            bottomNavigationBar: _buildAddNewEducation()));
  }
        ...
        child: Column(
            ...
            children: [
              ...
              Obx(() => ListView.separated(
                  ...
                  itemCount: controller.experienceSettingModelObj.value
                      .experiencesettingItemList.value.length,
                  itemBuilder: (context, index) {
                    ExperiencesettingItemModel model = controller
  ...
  Widget _buildEducation2() {
    return Container(
        ...
        child: Column(
            ...
            children: [
              _buildEducation(education: "lbl_education".tr),
