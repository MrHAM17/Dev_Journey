...
class NotificationsMyProposalsPage extends StatelessWidget {
  NotificationsMyProposalsPage({Key? key}) : super(key: key);

  NotificationsMyProposalsController controller = Get.put(
      NotificationsMyProposalsController(NotificationsMyProposalsModel().obs));
    ...
    return SafeArea(
        child: Scaffold(
            body: Container(
                ...
                child: Column(
                    children: [SizedBox(height: 24.v), _buildOpened()]))));
  }
    ...
    return Padding(
        ...
        child: Column(children: [
          ...
          Obx(() => ListView.separated(
              ...
              itemCount: controller.notificationsMyProposalsModelObj.value
                  .notificationsmyproposalsItemList.value.length,
              itemBuilder: (context, index) {
                NotificationsmyproposalsItemModel model = controller
