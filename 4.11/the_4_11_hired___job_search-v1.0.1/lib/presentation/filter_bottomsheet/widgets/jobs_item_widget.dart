  ...
  Widget build(BuildContext context) {
    return Obx(
      () => RawChip(
        ...
        label: Text(
          jobsItemModelObj.jobs!.value,
          style: TextStyle(
            color: (jobsItemModelObj.isSelected?.value ?? false)
        ...
        onSelected: (value) {
          jobsItemModelObj.isSelected!.value = value;
        },
      ),
    );
  }
