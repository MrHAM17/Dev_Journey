import '../add_new_property_select_amenities_screen/widgets/options_item_widget.dart';import 'package:flutter/material.dart';import 'package:the_7_21_vertex___real_estate_app/core/app_export.dart';import 'package:the_7_21_vertex___real_estate_app/widgets/app_bar/appbar_leading_iconbutton.dart';import 'package:the_7_21_vertex___real_estate_app/widgets/app_bar/appbar_subtitle_two.dart';import 'package:the_7_21_vertex___real_estate_app/widgets/app_bar/custom_app_bar.dart';import 'package:the_7_21_vertex___real_estate_app/widgets/custom_elevated_button.dart';class AddNewPropertySelectAmenitiesScreen extends StatelessWidget {const AddNewPropertySelectAmenitiesScreen({Key? key}) : super(key: key);
...
/// Section Widget
Widget _buildSelectAmenitites(BuildContext context) { return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [Text("Select Amenities", style: CustomTextStyles.titleMediumBold_1), SizedBox(height: 15.v), Wrap(runSpacing: 8.v, spacing: 8.h, children: List<Widget>.generate(8, (index) => OptionsItemWidget()))]); } 
/// Section Widget
