...
/// Section Widget
Widget _buildInputs() { return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [Text("msg_property_address".tr, style: CustomTextStyles.titleMediumBold_1), SizedBox(height: 13.v), CustomTextFormField(controller: controller.addressController, hintText: "msg_tell_us_about_your".tr, textInputAction: TextInputAction.done)]); } 
/// Section Widget
