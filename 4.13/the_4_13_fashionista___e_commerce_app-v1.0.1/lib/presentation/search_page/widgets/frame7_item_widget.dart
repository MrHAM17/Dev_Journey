...
import 'package:the_4_13_fashionista___e_commerce_app/widgets/custom_rating_bar.dart';
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          Obx(
            () => CustomImageView(
              imagePath: frame7ItemModelObj.premiumWatch!.value,
              height: 58.adaptSize,
              width: 58.adaptSize,
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                Obx(
                  () => Text(
                    frame7ItemModelObj.premiumWatch1!.value,
