...
import 'package:the_3_15_safebank___mobile_banking_app/widgets/app_bar/appbar_trailing_circleimage.dart';
...
class MinePage extends StatelessWidget {
  ...
  Widget _buildRecentTransfer(BuildContext context) {
    return Column(children: [
      ...
      BlocSelector<MineBloc, MineState, MineModel?>(
          selector: (state) => state.mineModelObj,
          builder: (context, mineModelObj) {
            return ListView.separated(
                ...
                itemCount: mineModelObj?.fifteenItemList.length ?? 0,
                itemBuilder: (context, index) {
                  FifteenItemModel model =
                      mineModelObj?.fifteenItemList[index] ??
                          FifteenItemModel();
