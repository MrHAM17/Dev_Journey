...
import 'package:the_3_10_social___social_networking/presentation/stream_page/models/stream_model.dart';
...
class StreamBloc extends Bloc<StreamEvent, StreamState> {
  ...
  List<StreamItemModel> fillStreamItemList() {
    return [StreamItemModel(eighteen: ImageConstant.img18)];
  }
}
