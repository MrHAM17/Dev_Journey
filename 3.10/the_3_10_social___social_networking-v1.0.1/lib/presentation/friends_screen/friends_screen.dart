...
import 'package:the_3_10_social___social_networking/widgets/custom_outlined_button.dart';
import 'package:the_3_10_social___social_networking/widgets/custom_search_view.dart';
...
class FriendsScreen extends StatelessWidget {
              ...
              child: BlocSelector<FriendsBloc, FriendsState, FriendsModel?>(
                  ...
                  builder: (context, friendsModelObj) {
                    return ListView.separated(
                        ...
                        itemCount:
                            friendsModelObj?.eightythreeItemList.length ?? 0,
                        itemBuilder: (context, index) {
                          EightythreeItemModel model =
                              friendsModelObj?.eightythreeItemList[index] ??
  ...
  Widget _buildFollow(BuildContext context) {
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      BlocSelector<FriendsBloc, FriendsState, FriendsModel?>(
          selector: (state) => state.friendsModelObj,
          builder: (context, friendsModelObj) {
            return ListView.separated(
