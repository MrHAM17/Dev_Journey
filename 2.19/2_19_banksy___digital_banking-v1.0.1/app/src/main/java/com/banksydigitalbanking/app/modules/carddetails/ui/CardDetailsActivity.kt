...
import com.banksydigitalbanking.app.databinding.ActivityCardDetailsBinding
import com.banksydigitalbanking.app.modules.carddetails.`data`.model.CarddetailsRowModel
import com.banksydigitalbanking.app.modules.carddetails.`data`.viewmodel.CardDetailsVM
import kotlin.Int
...
class CardDetailsActivity : BaseActivity<ActivityCardDetailsBinding>(R.layout.activity_card_details)
  ...
  override fun onInitialized(): Unit {
    ...
    object : CardDetailsAdapter.OnItemClickListener {
      override fun onItemClick(view:View, position:Int, item : CarddetailsRowModel) {
