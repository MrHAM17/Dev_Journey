    ...
    return Obx(
      () => ListView.separated(
        ...
        itemCount: controller
            .goLiveTogetherModelObj.value.golivetogetherItemList.value.length,
        itemBuilder: (context, index) {
          GolivetogetherItemModel model = controller
              .goLiveTogetherModelObj.value.golivetogetherItemList.value[index];
