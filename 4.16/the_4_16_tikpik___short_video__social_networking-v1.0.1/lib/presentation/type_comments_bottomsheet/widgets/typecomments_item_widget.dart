                ...
                children: [
                  Align(
                    ...
                    child: Container(
                      ...
                      child: Obx(
                        () => Text(
                          typecommentsItemModelObj.adipiscingElit!.value,
                          maxLines: 2,
                        ...
                        Row(
                          children: [
                            ...
                            Padding(
                              ...
                              child: Obx(
                                () => Text(
                                  typecommentsItemModelObj.kristinWatson!.value,
                        ...
                        Row(
                          children: [
                            Obx(
                              () => CustomImageView(
                                imagePath:
                                    typecommentsItemModelObj.image!.value,
                                height: 24.adaptSize,
                                width: 24.adaptSize,
                              ),
                            ),
                            Padding(
                              ...
                              child: Obx(
                                () => Text(
                                  typecommentsItemModelObj.text!.value,
                            ...
                            Padding(
                              ...
                              child: Obx(
                                () => Text(
                                  typecommentsItemModelObj.duration!.value,
                            ...
                            Padding(
                              ...
                              child: Obx(
                                () => Text(
                                  typecommentsItemModelObj.reply!.value,
                                  style: CustomTextStyles.labelLargeGray700,
                                ),
                              ),
                            ),
