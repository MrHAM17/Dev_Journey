...
import 'notifier/booking_completed_notifier.dart';
...
class BookingCompletedPage extends ConsumerStatefulWidget {
...
class BookingCompletedPageState extends ConsumerState<BookingCompletedPage> {
  @override
    ...
    return Consumer(
      builder: (context, ref, _) {
        return ListView.separated(
          ...
          itemCount: ref
                  .watch(bookingCompletedNotifier)
                  .bookingCompletedModelObj
                  ?.ticketsItemList
                  .length ??
              0,
          itemBuilder: (context, index) {
            TicketsItemModel model = ref
                    .watch(bookingCompletedNotifier)
                    .bookingCompletedModelObj
                    ?.ticketsItemList[index] ??
                TicketsItemModel();
