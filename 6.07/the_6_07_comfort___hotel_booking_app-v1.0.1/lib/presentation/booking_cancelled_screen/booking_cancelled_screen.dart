...
import 'notifier/booking_cancelled_notifier.dart';
import 'package:flutter/material.dart';
import 'package:the_6_07_comfort___hotel_booking_app/core/app_export.dart';
import 'package:the_6_07_comfort___hotel_booking_app/presentation/home_screen_tab_container_page/home_screen_tab_container_page.dart';
import 'package:the_6_07_comfort___hotel_booking_app/presentation/profile_settings_page/profile_settings_page.dart';
import 'package:the_6_07_comfort___hotel_booking_app/presentation/search_page_tab_container_page/search_page_tab_container_page.dart';
import 'package:the_6_07_comfort___hotel_booking_app/widgets/app_bar/appbar_leading_iconbutton.dart';
import 'package:the_6_07_comfort___hotel_booking_app/widgets/app_bar/appbar_title.dart';
import 'package:the_6_07_comfort___hotel_booking_app/widgets/app_bar/appbar_trailing_image.dart';
import 'package:the_6_07_comfort___hotel_booking_app/widgets/app_bar/custom_app_bar.dart';
import 'package:the_6_07_comfort___hotel_booking_app/widgets/custom_bottom_bar.dart';

class BookingCancelledScreen extends ConsumerStatefulWidget {
...
class BookingCancelledScreenState
    extends ConsumerState<BookingCancelledScreen> {
    ...
    return Consumer(
      builder: (context, ref, _) {
        return ListView.separated(
          ...
          itemCount: ref
                  .watch(bookingCancelledNotifier)
                  .bookingCancelledModelObj
                  ?.tickets2ItemList
                  .length ??
              0,
          itemBuilder: (context, index) {
            Tickets2ItemModel model = ref
                    .watch(bookingCancelledNotifier)
                    .bookingCancelledModelObj
                    ?.tickets2ItemList[index] ??
                Tickets2ItemModel();
