...
import 'package:the_3_06_helthio___telehealth/presentation/articles_screen/models/articles_model.dart';
...
class ArticlesBloc extends Bloc<ArticlesEvent, ArticlesState> {
  ...
  List<SixtyItemModel> fillSixtyItemList() {
    return [
      SixtyItemModel(
  ...
  _onInitialize(
    ...
    emit(state.copyWith(
        articlesModelObj: state.articlesModelObj?.copyWith(
            ...
            sixtyItemList: fillSixtyItemList())));
