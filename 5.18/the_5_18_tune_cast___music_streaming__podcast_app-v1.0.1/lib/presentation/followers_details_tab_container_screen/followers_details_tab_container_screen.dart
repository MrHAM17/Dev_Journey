import 'models/followers_details_tab_container_model.dart';import 'package:flutter/material.dart';import 'package:the_5_18_tune_cast___music_streaming__podcast_app/core/app_export.dart';import 'package:the_5_18_tune_cast___music_streaming__podcast_app/presentation/followers_details_page/followers_details_page.dart';import 'package:the_5_18_tune_cast___music_streaming__podcast_app/widgets/app_bar/appbar_leading_image.dart';import 'package:the_5_18_tune_cast___music_streaming__podcast_app/widgets/app_bar/appbar_trailing_iconbutton_one.dart';import 'package:the_5_18_tune_cast___music_streaming__podcast_app/widgets/app_bar/appbar_trailing_image.dart';import 'package:the_5_18_tune_cast___music_streaming__podcast_app/widgets/app_bar/custom_app_bar.dart';import 'provider/followers_details_tab_container_provider.dart';class FollowersDetailsTabContainerScreen extends StatefulWidget {const FollowersDetailsTabContainerScreen({Key? key}) : super(key: key);

@override FollowersDetailsTabContainerScreenState createState() =>  FollowersDetailsTabContainerScreenState();

static Widget builder(BuildContext context) { return ChangeNotifierProvider(create: (context) => FollowersDetailsTabContainerProvider(), child: FollowersDetailsTabContainerScreen()); } 
 }
