...
import 'package:the_5_18_tune_cast___music_streaming__podcast_app/presentation/search_not_found_page/search_not_found_page.dart';
import 'package:the_5_18_tune_cast___music_streaming__podcast_app/widgets/custom_search_view.dart';
import 'provider/search_not_found_tab_container_provider.dart';
...
class SearchNotFoundTabContainerScreen extends StatefulWidget {
  ...
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => SearchNotFoundTabContainerProvider(),
          ...
          child: Column(
            children: [
              ...
              Padding(
                ...
                child: Selector<SearchNotFoundTabContainerProvider,
