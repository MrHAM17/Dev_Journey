import 'notifier/add_new_property_decsription_notifier.dart';import 'package:flutter/material.dart';import 'package:the_6_21_vertex___real_estate_app/core/app_export.dart';import 'package:the_6_21_vertex___real_estate_app/widgets/app_bar/appbar_leading_iconbutton.dart';import 'package:the_6_21_vertex___real_estate_app/widgets/app_bar/appbar_subtitle_two.dart';import 'package:the_6_21_vertex___real_estate_app/widgets/app_bar/custom_app_bar.dart';import 'package:the_6_21_vertex___real_estate_app/widgets/custom_elevated_button.dart';import 'package:the_6_21_vertex___real_estate_app/widgets/custom_text_form_field.dart';class AddNewPropertyDecsriptionScreen extends ConsumerStatefulWidget {const AddNewPropertyDecsriptionScreen({Key? key}) : super(key: key);

@override AddNewPropertyDecsriptionScreenState createState() =>  AddNewPropertyDecsriptionScreenState();

 }
class AddNewPropertyDecsriptionScreenState extends ConsumerState<AddNewPropertyDecsriptionScreen> {@override Widget build(BuildContext context) { return SafeArea(child: Scaffold(resizeToAvoidBottomInset: false, appBar: _buildAppBar(context), body: Container(width: double.maxFinite, padding: EdgeInsets.all(24.h), child: Column(children: [_buildAddressAndProgress(context), SizedBox(height: 16.v), Container(height: 6.v, width: 327.h, decoration: BoxDecoration(color: appTheme.gray300, borderRadius: BorderRadius.circular(3.h)), child: ClipRRect(borderRadius: BorderRadius.circular(3.h), child: LinearProgressIndicator(value: 0.62, backgroundColor: appTheme.gray300, valueColor: AlwaysStoppedAnimation<Color>(theme.colorScheme.primary)))), SizedBox(height: 26.v), _buildInputs(context), SizedBox(height: 5.v)])), bottomNavigationBar: _buildBTN(context))); } 
/// Section Widget
...
/// Section Widget
Widget _buildInputs(BuildContext context) { return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [Text("msg_property_address".tr, style: CustomTextStyles.titleMediumBold_1), SizedBox(height: 13.v), Consumer(builder: (context, ref, _) {return CustomTextFormField(controller: ref.watch(addNewPropertyDecsriptionNotifier).addressController, hintText: "msg_tell_us_about_your".tr, textInputAction: TextInputAction.done);})]); } 
/// Section Widget
