...
import 'package:the_4_06_helthio___telehealth/widgets/app_bar/appbar_subtitle_three.dart';
...
class ChatWithDoctorScreen extends GetWidget<ChatWithDoctorController> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
        child: Scaffold(
            ...
            bottomNavigationBar: _buildSeventySix()));
  }
  ...
  Widget _buildEightyEight() {
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      Padding(
          padding: EdgeInsets.only(left: 90.h),
          child: _buildChatTile(iDonTHaveAny: "msg_i_have_suffering".tr))
    ]);
  }
