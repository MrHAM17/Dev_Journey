    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          Obx(
            () => CustomImageView(
              imagePath: sixtyItemModelObj.image!.value,
              height: 59.adaptSize,
              width: 59.adaptSize,
            ...
            child: Column(
              ...
              children: [
                SizedBox(
                  ...
                  child: Obx(
                    () => Text(
                      sixtyItemModelObj.theHealthiest!.value,
                      maxLines: 2,
          ...
          Obx(
            () => CustomImageView(
              imagePath: sixtyItemModelObj.image1!.value,
              height: 12.v,
              width: 10.h,
              margin: EdgeInsets.only(
                left: 27.h,
