...
import 'provider/notifications_general_provider.dart';
...
class NotificationsGeneralPage extends StatefulWidget {
  ...
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
        create: (context) => NotificationsGeneralProvider(),
...
class NotificationsGeneralPageState extends State<NotificationsGeneralPage>
  ...
  Widget _buildNotificationsGeneral(BuildContext context) {
    return Padding(
        ...
        child: Consumer<NotificationsGeneralProvider>(
          ...
          return ListView.separated(
              ...
              itemCount: provider.notificationsGeneralModelObj
                  .notificationsgeneralItemList.length,
              itemBuilder: (context, index) {
                NotificationsgeneralItemModel model = provider
