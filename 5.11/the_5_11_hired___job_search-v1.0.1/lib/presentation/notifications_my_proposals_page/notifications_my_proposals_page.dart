...
import 'provider/notifications_my_proposals_provider.dart';
...
class NotificationsMyProposalsPage extends StatefulWidget {
  ...
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
        create: (context) => NotificationsMyProposalsProvider(),
  ...
  Widget _buildOpened(BuildContext context) {
    return Padding(
        ...
        child: Column(children: [
          ...
          Consumer<NotificationsMyProposalsProvider>(
            ...
            return ListView.separated(
                ...
                itemCount: provider.notificationsMyProposalsModelObj
                    .notificationsmyproposalsItemList.length,
                itemBuilder: (context, index) {
                  NotificationsmyproposalsItemModel model = provider
