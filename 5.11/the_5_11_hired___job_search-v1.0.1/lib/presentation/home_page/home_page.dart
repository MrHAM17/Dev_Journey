...
import 'package:the_5_11_hired___job_search/widgets/app_bar/appbar_leading_circleimage.dart';
import 'package:the_5_11_hired___job_search/widgets/app_bar/appbar_subtitle.dart';
import 'package:the_5_11_hired___job_search/widgets/app_bar/appbar_subtitle_one.dart';
        ...
        child: Consumer<HomeProvider>(
          builder: (context, provider, child) {
            return ListView.separated(
              ...
              itemCount: provider.homeModelObj.eightyeightItemList.length,
              itemBuilder: (context, index) {
                EightyeightItemModel model =
                    provider.homeModelObj.eightyeightItemList[index];
