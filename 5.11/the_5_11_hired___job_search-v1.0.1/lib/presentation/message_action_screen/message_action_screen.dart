...
import 'provider/message_action_provider.dart';
...
class MessageActionScreen extends StatefulWidget {
  ...
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
        create: (context) => MessageActionProvider(),
        child: MessageActionScreen());
  }
}

// ignore_for_file: must_be_immutable
class MessageActionScreenState extends State<MessageActionScreen> {
            ...
            body: Container(
                ...
                child: Column(children: [
                  ...
                  Padding(
                      ...
                      child: Selector<MessageActionProvider,
  ...
  Widget _buildMessageAction(BuildContext context) {
    return Consumer<MessageActionProvider>(builder: (context, provider, child) {
      return ListView.separated(
          ...
          itemCount:
              provider.messageActionModelObj.messageactionItemList.length,
          itemBuilder: (context, index) {
            MessageactionItemModel model =
                provider.messageActionModelObj.messageactionItemList[index];
