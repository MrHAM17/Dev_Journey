...
import 'package:the_5_11_hired___job_search/presentation/enter_otp_page/enter_otp_page.dart';
...
import 'provider/enter_otp_tab_container_provider.dart';
...
class EnterOtpTabContainerScreen extends StatefulWidget {
  ...
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => EnterOtpTabContainerProvider(),
