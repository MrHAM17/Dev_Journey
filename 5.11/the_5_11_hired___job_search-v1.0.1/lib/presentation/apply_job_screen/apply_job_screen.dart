...
import 'provider/apply_job_provider.dart';
import 'package:the_5_11_hired___job_search/presentation/apply_job_popup_dialog/apply_job_popup_dialog.dart';
...
class ApplyJobScreen extends StatefulWidget {
  ...
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
        create: (context) => ApplyJobProvider(), child: ApplyJobScreen());
  }
}
  ...
  Widget _buildINPUTFIELD(BuildContext context) {
    return Container(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          SizedBox(height: 9.v),
          Selector<ApplyJobProvider, TextEditingController?>(
