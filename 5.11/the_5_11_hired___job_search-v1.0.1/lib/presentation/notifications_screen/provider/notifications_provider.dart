...
import 'package:the_5_11_hired___job_search/presentation/notifications_screen/models/notifications_model.dart';
...
class NotificationsProvider extends ChangeNotifier {
  ...
  void changeSwitchBox1(
    ...
    notificationsModelObj.notificationsItemList[index].isSelectedSwitch = value;
    notifyListeners();
  }
}
