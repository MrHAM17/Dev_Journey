...
import 'package:the_5_11_hired___job_search/widgets/custom_icon_button.dart';
import 'provider/experience_setting_provider.dart';

class ExperienceSettingScreen extends StatefulWidget {
  const ExperienceSettingScreen({Key? key}) : super(key: key);

  @override
  ExperienceSettingScreenState createState() => ExperienceSettingScreenState();

  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
        create: (context) => ExperienceSettingProvider(),
        child: ExperienceSettingScreen());
  }
}

class ExperienceSettingScreenState extends State<ExperienceSettingScreen> {
  @override
  void initState() {
    super.initState();
  }
    ...
    return Container(
        ...
        child: Column(
            ...
            children: [
              ...
              Consumer<ExperienceSettingProvider>(
                ...
                return ListView.separated(
                    ...
                    itemCount: provider.experienceSettingModelObj
                        .experiencesettingItemList.length,
                    itemBuilder: (context, index) {
                      ExperiencesettingItemModel model = provider
