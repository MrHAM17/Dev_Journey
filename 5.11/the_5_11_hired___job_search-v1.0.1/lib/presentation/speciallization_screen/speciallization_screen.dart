...
import 'provider/speciallization_provider.dart';
import 'package:the_5_11_hired___job_search/presentation/confirmation_dialog/confirmation_dialog.dart';

class SpeciallizationScreen extends StatefulWidget {
  const SpeciallizationScreen({Key? key}) : super(key: key);

  @override
  SpeciallizationScreenState createState() => SpeciallizationScreenState();

  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
        create: (context) => SpeciallizationProvider(),
        child: SpeciallizationScreen());
  }
}

class SpeciallizationScreenState extends State<SpeciallizationScreen> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Widget _buildSpeciallization(BuildContext context) {
    return Padding(
        ...
        child: Consumer<SpeciallizationProvider>(
          ...
          return ListView.separated(
              ...
              itemCount: provider
                  .speciallizationModelObj.speciallizationItemList.length,
              itemBuilder: (context, index) {
                SpeciallizationItemModel model = provider
                    .speciallizationModelObj.speciallizationItemList[index];
