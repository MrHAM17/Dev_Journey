...
import 'provider/sign_up_complete_account_provider.dart';
...
class SignUpCompleteAccountScreen extends StatefulWidget {
  ...
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
        create: (context) => SignUpCompleteAccountProvider(),
  ...
  Widget _buildINPUTFIELD(BuildContext context) {
    return Container(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          SizedBox(height: 9.v),
          Selector<SignUpCompleteAccountProvider, TextEditingController?>(
  ...
  Widget _buildINPUTFIELD2(BuildContext context) {
    return Container(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          SizedBox(height: 9.v),
          Consumer<SignUpCompleteAccountProvider>(
