...
import 'provider/logout_popup_provider.dart';

class LogoutPopupDialog extends StatefulWidget {
  const LogoutPopupDialog({Key? key}) : super(key: key);

  @override
  LogoutPopupDialogState createState() => LogoutPopupDialogState();

  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
        create: (context) => LogoutPopupProvider(), child: LogoutPopupDialog());
  }
}

class LogoutPopupDialogState extends State<LogoutPopupDialog> {
  @override
  void initState() {
    super.initState();
  }
