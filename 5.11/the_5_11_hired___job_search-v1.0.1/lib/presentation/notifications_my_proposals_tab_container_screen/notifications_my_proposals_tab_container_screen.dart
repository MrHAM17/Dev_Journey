...
import 'package:the_5_11_hired___job_search/presentation/notifications_general_page/notifications_general_page.dart';
...
import 'provider/notifications_my_proposals_tab_container_provider.dart';
...
class NotificationsMyProposalsTabContainerScreen extends StatefulWidget {
  ...
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
        create: (context) => NotificationsMyProposalsTabContainerProvider(),
