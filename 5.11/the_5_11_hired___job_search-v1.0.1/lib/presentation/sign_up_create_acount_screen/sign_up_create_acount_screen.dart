...
import 'package:the_5_11_hired___job_search/widgets/custom_outlined_button.dart';
import 'package:the_5_11_hired___job_search/widgets/custom_text_form_field.dart';
import 'provider/sign_up_create_acount_provider.dart';
import 'package:the_5_11_hired___job_search/domain/googleauth/google_auth_helper.dart';

class SignUpCreateAcountScreen extends StatefulWidget {
  const SignUpCreateAcountScreen({Key? key}) : super(key: key);

  @override
  SignUpCreateAcountScreenState createState() =>
      SignUpCreateAcountScreenState();

  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
        create: (context) => SignUpCreateAcountProvider(),
        child: SignUpCreateAcountScreen());
  }
}

// ignore_for_file: must_be_immutable
class SignUpCreateAcountScreenState extends State<SignUpCreateAcountScreen> {
  ...
  Widget _buildINPUTFIELD(BuildContext context) {
    return Container(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          SizedBox(height: 9.v),
          Selector<SignUpCreateAcountProvider, TextEditingController?>(
