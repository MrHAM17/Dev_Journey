...
class FriendsModel {
  Rx<List<EightythreeItemModel>> eightythreeItemList = Rx([
    EightythreeItemModel(trash: ImageConstant.imgTrashBlue500.obs),
    EightythreeItemModel(trash: ImageConstant.imgFacebookBlueA400.obs),
    EightythreeItemModel(trash: ImageConstant.imgThumbsUp.obs)
  ]);
