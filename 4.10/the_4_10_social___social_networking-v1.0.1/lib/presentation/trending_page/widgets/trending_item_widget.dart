      ...
      child: Column(
        ...
        children: [
          SizedBox(
            ...
            child: Stack(
              ...
              children: [
                Obx(
                  () => CustomImageView(
                    imagePath: trendingItemModelObj.image!.value,
                    height: 221.v,
                    width: 382.h,
                        ...
                        Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              Obx(
                                () => Text(
                                  trendingItemModelObj.rickOnad!.value,
                              ...
                              Obx(
                                () => Text(
                                  trendingItemModelObj.time!.value,
          ...
          Container(
            ...
            child: Obx(
              () => Text(
                trendingItemModelObj.thisIsTheMoment!.value,
                maxLines: 2,
            ...
            child: Row(
              children: [
                Padding(
                  ...
                  child: Obx(
                    () => Text(
                      trendingItemModelObj.huge!.value,
                      style: theme.textTheme.bodyMedium,
                    ),
                  ),
                ),
                Padding(
                  ...
                  child: Obx(
                    () => Text(
                      trendingItemModelObj.fotography!.value,
                      style: theme.textTheme.bodyMedium,
                    ),
                  ),
                ),
                Padding(
                  ...
                  child: Obx(
                    () => Text(
                      trendingItemModelObj.nature!.value,
                      style: theme.textTheme.bodyMedium,
                    ),
                  ),
                ),
