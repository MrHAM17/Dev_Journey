...
_onInitialize(HomeScreenContainerInitialEvent event, Emitter<HomeScreenContainerState> emit, ) async  { NavigatorService.pushNamed(AppRoutes.notificationsScreen, ); } 
 }
