...
_onInitialize(ProfileSettingsInitialEvent event, Emitter<ProfileSettingsState> emit, ) async  { emit(state.copyWith(isSelectedSwitch: false));// TODO: implement Actions
NavigatorService.pushNamed(AppRoutes.editProfileScreen, );NavigatorService.pushNamed(AppRoutes.notificationSettingsScreen, );NavigatorService.pushNamed(AppRoutes.securityScreen, ); } 
 }
