...
_onInitialize(ForgotPasswordTypeOtpInitialEvent event, Emitter<ForgotPasswordTypeOtpState> emit, ) async  { emit(state.copyWith(otpController: TextEditingController())); listenForCode();NavigatorService.pushNamed(AppRoutes.forgotPasswordFilledTypeScreen, ); } 
 }
