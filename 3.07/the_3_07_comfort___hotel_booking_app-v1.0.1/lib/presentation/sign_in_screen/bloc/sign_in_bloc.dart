...
_onInitialize(SignInInitialEvent event, Emitter<SignInState> emit, ) async  { emit(state.copyWith(emailController: TextEditingController(), passwordController: TextEditingController(), isShowPassword: true, rememberme: false));NavigatorService.pushNamed(AppRoutes.signUpBlankScreen, );NavigatorService.pushNamed(AppRoutes.forgotPasswordScreen, ); } 
 }
