...
_onInitialize(SignUpBlankInitialEvent event, Emitter<SignUpBlankState> emit, ) async  { emit(state.copyWith(emailController: TextEditingController(), passwordController: TextEditingController(), isShowPassword: true, rememberme: false));NavigatorService.pushNamed(AppRoutes.fillProfileScreen, ); } 
 }
