...
_onInitialize(LetSYouInInitialEvent event, Emitter<LetSYouInState> emit, ) async  { NavigatorService.pushNamed(AppRoutes.signInScreen, );NavigatorService.pushNamed(AppRoutes.signUpBlankScreen, ); } 
 }
