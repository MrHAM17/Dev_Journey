...
_onInitialize(BookingNameInitialEvent event, Emitter<BookingNameState> emit, ) async  { emit(state.copyWith(labelController: TextEditingController(), labelController1: TextEditingController(), dateController: TextEditingController(), emailController: TextEditingController(), phoneController: TextEditingController()));NavigatorService.pushNamed(AppRoutes.choosePaymentMethodScreen, ); } 
 }
