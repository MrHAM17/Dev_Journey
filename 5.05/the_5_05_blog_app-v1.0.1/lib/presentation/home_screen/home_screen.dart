        ...
        child: SizedBox(
            ...
            child: Consumer<HomeProvider>(builder: (context, provider, child) {
              return ListView.separated(
                  ...
                  itemCount:
                      provider.homeModelObj.framethirtysixItemList.length,
                  itemBuilder: (context, index) {
                    FramethirtysixItemModel model =
                        provider.homeModelObj.framethirtysixItemList[index];
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Consumer<HomeProvider>(builder: (context, provider, child) {
            return ListView.separated(
                ...
                itemCount: provider.homeModelObj.storiesItemList.length,
                itemBuilder: (context, index) {
                  StoriesItemModel model =
                      provider.homeModelObj.storiesItemList[index];
