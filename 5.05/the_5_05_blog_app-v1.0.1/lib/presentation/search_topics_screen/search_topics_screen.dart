...
import 'package:the_5_05_blog_app/widgets/app_bar/appbar_title_searchview.dart';
import 'package:the_5_05_blog_app/widgets/app_bar/custom_app_bar.dart';
import 'provider/search_topics_provider.dart';

class SearchTopicsScreen extends StatefulWidget {
  ...
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
        create: (context) => SearchTopicsProvider(),
        child: SearchTopicsScreen());
  }
}

class SearchTopicsScreenState extends State<SearchTopicsScreen> {
  @override
  void initState() {
    super.initState();
  }
  ...
  PreferredSizeWidget _buildAppBar(BuildContext context) {
    return CustomAppBar(
        ...
        title: Selector<SearchTopicsProvider, TextEditingController?>(
