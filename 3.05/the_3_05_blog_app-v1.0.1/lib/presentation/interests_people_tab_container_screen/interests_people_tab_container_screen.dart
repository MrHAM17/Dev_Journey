import 'bloc/interests_people_tab_container_bloc.dart';
import 'models/interests_people_tab_container_model.dart';
import 'package:flutter/material.dart';
import 'package:the_3_05_blog_app/core/app_export.dart';
import 'package:the_3_05_blog_app/presentation/interests_people_page/interests_people_page.dart';
import 'package:the_3_05_blog_app/presentation/interests_topics_page/interests_topics_page.dart';
...
class InterestsPeopleTabContainerScreen extends StatefulWidget {
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<InterestsPeopleTabContainerBloc>(
      create: (context) =>
          InterestsPeopleTabContainerBloc(InterestsPeopleTabContainerState(
        interestsPeopleTabContainerModelObj: InterestsPeopleTabContainerModel(),
      ))
            ..add(InterestsPeopleTabContainerInitialEvent()),
...
class InterestsPeopleTabContainerScreenState
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<InterestsPeopleTabContainerBloc,
        InterestsPeopleTabContainerState>(
