...
import 'package:the_6_10_social___social_networking/presentation/invite_friends_screen/models/invite_friends_model.dart';
part 'invite_friends_state.dart';

final inviteFriendsNotifier =
    StateNotifierProvider<InviteFriendsNotifier, InviteFriendsState>(
        (ref) => InviteFriendsNotifier(InviteFriendsState(
                inviteFriendsModelObj: InviteFriendsModel(friendlistItemList: [
              FriendlistItemModel(
...
/// A notifier that manages the state of a InviteFriends according to the event that is dispatched to it.
class InviteFriendsNotifier extends StateNotifier<InviteFriendsState> {
  InviteFriendsNotifier(InviteFriendsState state) : super(state);
}
