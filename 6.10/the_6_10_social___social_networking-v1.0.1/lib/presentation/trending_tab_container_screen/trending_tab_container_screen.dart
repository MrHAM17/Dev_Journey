...
import 'notifier/trending_tab_container_notifier.dart';
...
import 'package:the_6_10_social___social_networking/presentation/trending_page/trending_page.dart';
...
class TrendingTabContainerScreen extends ConsumerStatefulWidget {
...
class TrendingTabContainerScreenState
    extends ConsumerState<TrendingTabContainerScreen>
    ...
    return CustomAppBar(
        title: Consumer(builder: (context, ref, _) {
          return AppbarTitleSearchview(
              ...
              controller:
                  ref.watch(trendingTabContainerNotifier).searchController);
        }),
        actions: [
          AppbarTrailingImage(
    ...
    return SizedBox(
        ...
        child: Consumer(builder: (context, ref, _) {
          return ListView.separated(
              ...
              itemCount: ref
                      .watch(trendingTabContainerNotifier)
