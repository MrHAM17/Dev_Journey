...
import 'notifier/page_view_notifier.dart';
...
class PageViewScreenState extends ConsumerState<PageViewScreen> {
  @override
    ...
    return SizedBox(
        ...
        child: Consumer(builder: (context, ref, _) {
          return ListView.separated(
              ...
              itemCount: ref
                      .watch(pageViewNotifier)
                      .pageViewModelObj
                      ?.conversionsItemList
                      .length ??
                  0,
              itemBuilder: (context, index) {
                ConversionsItemModel model = ref
                        .watch(pageViewNotifier)
                        .pageViewModelObj
                        ?.conversionsItemList[index] ??
          ...
          Row(mainAxisAlignment: MainAxisAlignment.center, children: [
            Expanded(child: Consumer(builder: (context, ref, _) {
              return CustomTextFormField(
                  controller: ref.watch(pageViewNotifier).commentController,
