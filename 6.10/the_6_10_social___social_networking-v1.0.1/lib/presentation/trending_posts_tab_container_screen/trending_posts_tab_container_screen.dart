import 'notifier/trending_posts_tab_container_notifier.dart';
...
import 'package:the_6_10_social___social_networking/presentation/stream_page/stream_page.dart';
...
class TrendingPostsTabContainerScreen extends ConsumerStatefulWidget {
...
class TrendingPostsTabContainerScreenState
    extends ConsumerState<TrendingPostsTabContainerScreen>
      ...
      title: Consumer(
        builder: (context, ref, _) {
          return AppbarTitleSearchview(
            ...
            controller:
                ref.watch(trendingPostsTabContainerNotifier).searchController,
          );
        },
      ),
      actions: [
