import 'notifier/send_money_enter_password_notifier.dart';
...
class SendMoneyEnterPasswordScreen extends ConsumerStatefulWidget {
...
class SendMoneyEnterPasswordScreenState
    extends ConsumerState<SendMoneyEnterPasswordScreen> {
  @override
                  ...
                  Padding(
                      ...
                      child: Consumer(builder: (context, ref, _) {
                        return CustomPinCodeTextField(
                            context: context,
                            controller: ref
                                .watch(sendMoneyEnterPasswordNotifier)
                                .otpController,
                            onChanged: (value) {
                              ref
                                  .watch(sendMoneyEnterPasswordNotifier)
