...
import 'provider/channel_five_provider.dart';

class ChannelFiveScreen extends StatefulWidget {
  ...
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
        create: (context) => ChannelFiveProvider(), child: ChannelFiveScreen());
  }
}

class ChannelFiveScreenState extends State<ChannelFiveScreen> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Widget _buildMovies(BuildContext context) {
    return SizedBox(
        height: 223.v,
        child:
            Consumer<ChannelFiveProvider>(builder: (context, provider, child) {
          return ListView.separated(
              ...
              itemCount: provider.channelFiveModelObj.movies6ItemList.length,
              itemBuilder: (context, index) {
                Movies6ItemModel model =
                    provider.channelFiveModelObj.movies6ItemList[index];
