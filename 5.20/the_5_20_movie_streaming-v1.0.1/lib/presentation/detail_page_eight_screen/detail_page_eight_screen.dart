...
import 'provider/detail_page_eight_provider.dart';

class DetailPageEightScreen extends StatefulWidget {
  const DetailPageEightScreen({Key? key}) : super(key: key);

  @override
  DetailPageEightScreenState createState() => DetailPageEightScreenState();

  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
        create: (context) => DetailPageEightProvider(),
        child: DetailPageEightScreen());
  }
}

class DetailPageEightScreenState extends State<DetailPageEightScreen> {
  @override
  void initState() {
    super.initState();
  ...
  Widget _buildMovies(BuildContext context) {
    return SizedBox(
        height: 243.v,
        child: Consumer<DetailPageEightProvider>(
          ...
          return ListView.separated(
              ...
              itemCount:
                  provider.detailPageEightModelObj.movies5ItemList.length,
              itemBuilder: (context, index) {
                Movies5ItemModel model =
                    provider.detailPageEightModelObj.movies5ItemList[index];
