...
import 'provider/channel_four_provider.dart';

class ChannelFourScreen extends StatefulWidget {
  const ChannelFourScreen({Key? key}) : super(key: key);

  @override
  ChannelFourScreenState createState() => ChannelFourScreenState();

  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
        create: (context) => ChannelFourProvider(), child: ChannelFourScreen());
  }
}

class ChannelFourScreenState extends State<ChannelFourScreen> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Widget _buildChannelFour(BuildContext context) {
    return Padding(
        ...
        child:
            Consumer<ChannelFourProvider>(builder: (context, provider, child) {
          return ListView.separated(
              ...
              itemCount:
                  provider.channelFourModelObj.channelfourItemList.length,
              itemBuilder: (context, index) {
                ChannelfourItemModel model =
                    provider.channelFourModelObj.channelfourItemList[index];
