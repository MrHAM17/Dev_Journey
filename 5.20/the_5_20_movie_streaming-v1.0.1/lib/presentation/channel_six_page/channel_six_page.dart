...
import 'provider/channel_six_provider.dart';

// ignore_for_file: must_be_immutable
class ChannelSixPage extends StatefulWidget {
  ...
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => ChannelSixProvider(),
      child: ChannelSixPage(),
    );
  }
}

class ChannelSixPageState extends State<ChannelSixPage> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Widget _buildChannelSix(BuildContext context) {
    return Padding(
      ...
      child: Consumer<ChannelSixProvider>(
        builder: (context, provider, child) {
          return ListView.separated(
            ...
            itemCount: provider.channelSixModelObj.channelsixItemList.length,
            itemBuilder: (context, index) {
              ChannelsixItemModel model =
                  provider.channelSixModelObj.channelsixItemList[index];
