...
import 'provider/detail_page_seven_provider.dart';

class DetailPageSevenScreen extends StatefulWidget {
  ...
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
        create: (context) => DetailPageSevenProvider(),
        child: DetailPageSevenScreen());
  }
}

class DetailPageSevenScreenState extends State<DetailPageSevenScreen> {
  @override
  void initState() {
    super.initState();
  ...
  Widget _buildMovies(BuildContext context) {
    return SizedBox(
        height: 243.v,
        child: Consumer<DetailPageSevenProvider>(
          ...
          return ListView.separated(
              ...
              itemCount: provider.detailPageSevenModelObj.moviesItemList.length,
              itemBuilder: (context, index) {
                MoviesItemModel model =
                    provider.detailPageSevenModelObj.moviesItemList[index];
