...
import 'provider/search_seven_provider.dart';

class SearchSevenScreen extends StatefulWidget {
  ...
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
        create: (context) => SearchSevenProvider(), child: SearchSevenScreen());
  }
}

class SearchSevenScreenState extends State<SearchSevenScreen> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Widget _buildSearchSeven(BuildContext context) {
    return Consumer<SearchSevenProvider>(builder: (context, provider, child) {
      return GridView.builder(
          ...
          itemCount: provider.searchSevenModelObj.searchsevenItemList.length,
          itemBuilder: (context, index) {
            SearchsevenItemModel model =
                provider.searchSevenModelObj.searchsevenItemList[index];
    ...
    return Consumer<SearchSevenProvider>(builder: (context, provider, child) {
      return Wrap(
          ...
          children: List<Widget>.generate(
              provider.searchSevenModelObj.frameseventynineItemList.length,
              (index) {
            FrameseventynineItemModel model =
                provider.searchSevenModelObj.frameseventynineItemList[index];
