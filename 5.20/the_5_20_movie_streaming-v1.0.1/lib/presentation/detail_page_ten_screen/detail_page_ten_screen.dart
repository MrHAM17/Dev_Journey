...
import 'provider/detail_page_ten_provider.dart';

class DetailPageTenScreen extends StatefulWidget {
  const DetailPageTenScreen({Key? key}) : super(key: key);

  @override
  DetailPageTenScreenState createState() => DetailPageTenScreenState();

  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
        create: (context) => DetailPageTenProvider(),
        child: DetailPageTenScreen());
  }
}

class DetailPageTenScreenState extends State<DetailPageTenScreen> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Widget _buildMovies(BuildContext context) {
    return SizedBox(
        height: 243.v,
        child: Consumer<DetailPageTenProvider>(
          ...
          return ListView.separated(
              ...
              itemCount: provider.detailPageTenModelObj.movies2ItemList.length,
              itemBuilder: (context, index) {
                Movies2ItemModel model =
                    provider.detailPageTenModelObj.movies2ItemList[index];
