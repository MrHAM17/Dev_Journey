...
import 'package:the_5_22_first_bank___digital_banking/core/utils/validation_functions.dart';
import 'package:the_5_22_first_bank___digital_banking/widgets/app_bar/appbar_leading_image.dart';
import 'package:the_5_22_first_bank___digital_banking/widgets/app_bar/appbar_title.dart';
import 'package:the_5_22_first_bank___digital_banking/widgets/app_bar/appbar_trailing_circleimage.dart';
import 'package:the_5_22_first_bank___digital_banking/widgets/app_bar/custom_app_bar.dart';
import 'package:the_5_22_first_bank___digital_banking/widgets/custom_elevated_button.dart';
import 'package:the_5_22_first_bank___digital_banking/widgets/custom_icon_button.dart';
import 'package:the_5_22_first_bank___digital_banking/widgets/custom_search_view.dart';
import 'package:the_5_22_first_bank___digital_banking/widgets/custom_text_form_field.dart';
...
class CreditCardsScreenState extends State<CreditCardsScreen> {
  ...
  Widget _buildBalance(BuildContext context) {
    return Consumer<CreditCardsProvider>(
      builder: (context, provider, child) {
        return CarouselSlider.builder(
          ...
          itemCount: provider.creditCardsModelObj.balance2ItemList.length,
          itemBuilder: (context, index, realIndex) {
            Balance2ItemModel model =
                provider.creditCardsModelObj.balance2ItemList[index];
          ...
          child: Consumer<CreditCardsProvider>(
            builder: (context, provider, child) {
              return ListView.separated(
                ...
                itemCount:
                    provider.creditCardsModelObj.creditcardsItemList.length,
                itemBuilder: (context, index) {
                  CreditcardsItemModel model =
                      provider.creditCardsModelObj.creditcardsItemList[index];
