    ...
    return SizedBox(
        ...
        child: Consumer<HomeProvider>(builder: (context, provider, child) {
          return ListView.separated(
              ...
              itemCount: provider.homeModelObj.balanceItemList.length,
              itemBuilder: (context, index) {
                BalanceItemModel model =
                    provider.homeModelObj.balanceItemList[index];
            ...
            SizedBox(
                ...
                child:
                  ...
                  return ListView.separated(
                      ...
                      itemCount:
                          provider.homeModelObj.liviabatorItemList.length,
                      itemBuilder: (context, index) {
                        LiviabatorItemModel model =
                            provider.homeModelObj.liviabatorItemList[index];
