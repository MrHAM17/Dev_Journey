import 'package:equatable/equatable.dart';import 'package:flutter/material.dart';import '/core/app_export.dart';import '../models/songs_item_model.dart';import 'package:the_3_18_tune_cast___music_streaming__podcast_app/presentation/songs_screen/models/songs_model.dart';part 'songs_event.dart';part 'songs_state.dart';/// A bloc that manages the state of a Songs according to the event that is dispatched to it.
