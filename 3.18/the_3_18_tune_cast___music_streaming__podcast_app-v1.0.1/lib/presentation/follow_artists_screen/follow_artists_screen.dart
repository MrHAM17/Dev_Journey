import '../follow_artists_screen/widgets/followartists_item_widget.dart';import 'bloc/follow_artists_bloc.dart';import 'models/follow_artists_model.dart';import 'models/followartists_item_model.dart';import 'package:flutter/material.dart';import 'package:the_3_18_tune_cast___music_streaming__podcast_app/core/app_export.dart';import 'package:the_3_18_tune_cast___music_streaming__podcast_app/widgets/app_bar/appbar_leading_image.dart';import 'package:the_3_18_tune_cast___music_streaming__podcast_app/widgets/app_bar/appbar_title.dart';import 'package:the_3_18_tune_cast___music_streaming__podcast_app/widgets/app_bar/custom_app_bar.dart';import 'package:the_3_18_tune_cast___music_streaming__podcast_app/widgets/custom_elevated_button.dart';import 'package:the_3_18_tune_cast___music_streaming__podcast_app/widgets/custom_outlined_button.dart';class FollowArtistsScreen extends StatelessWidget {const FollowArtistsScreen({Key? key}) : super(key: key);
...
/// Section Widget
Widget _buildFollowArtists(BuildContext context) { return BlocSelector<FollowArtistsBloc, FollowArtistsState, FollowArtistsModel?>(selector: (state) => state.followArtistsModelObj, builder: (context, followArtistsModelObj) {return ListView.separated(physics: NeverScrollableScrollPhysics(), shrinkWrap: true, separatorBuilder: (context, index) {return SizedBox(height: 16.v);}, itemCount: followArtistsModelObj?.followartistsItemList.length ?? 0, itemBuilder: (context, index) {FollowartistsItemModel model = followArtistsModelObj?.followartistsItemList[index] ?? FollowartistsItemModel(); return FollowartistsItemWidget(model);});}); } 
/// Section Widget
