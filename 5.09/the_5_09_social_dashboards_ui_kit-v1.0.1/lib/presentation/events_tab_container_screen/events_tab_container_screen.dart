...
import 'package:the_5_09_social_dashboards_ui_kit/presentation/events_page/events_page.dart';
...
import 'provider/events_tab_container_provider.dart';
...
class EventsTabContainerScreen extends StatefulWidget {
  ...
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
        create: (context) => EventsTabContainerProvider(),
