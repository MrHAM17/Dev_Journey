...
import 'package:the_5_09_social_dashboards_ui_kit/presentation/messages_page/messages_page.dart';
...
import 'provider/messages_tab_container_provider.dart';
...
class MessagesTabContainerScreen extends StatefulWidget {
  ...
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => MessagesTabContainerProvider(),
