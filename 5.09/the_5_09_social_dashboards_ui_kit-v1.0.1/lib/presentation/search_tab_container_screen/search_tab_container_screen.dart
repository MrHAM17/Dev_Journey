...
import 'package:the_5_09_social_dashboards_ui_kit/presentation/search_page/search_page.dart';
import 'package:the_5_09_social_dashboards_ui_kit/widgets/app_bar/appbar_leading_iconbutton_one.dart';
import 'package:the_5_09_social_dashboards_ui_kit/widgets/app_bar/appbar_title_searchview.dart';
import 'package:the_5_09_social_dashboards_ui_kit/widgets/app_bar/custom_app_bar.dart';
import 'provider/search_tab_container_provider.dart';
...
class SearchTabContainerScreen extends StatefulWidget {
  ...
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
        create: (context) => SearchTabContainerProvider(),
...
class SearchTabContainerScreenState extends State<SearchTabContainerScreen>
  ...
  PreferredSizeWidget _buildAppBar(BuildContext context) {
    return CustomAppBar(
        ...
        title: Selector<SearchTabContainerProvider, TextEditingController?>(
