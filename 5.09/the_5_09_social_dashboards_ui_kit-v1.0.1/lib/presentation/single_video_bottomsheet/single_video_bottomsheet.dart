...
class SingleVideoBottomsheet extends StatefulWidget {
  ...
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => SingleVideoProvider(),
      child: SingleVideoBottomsheet(),
    );
  }
}

class SingleVideoBottomsheetState extends State<SingleVideoBottomsheet> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Widget _buildTags(BuildContext context) {
    return Align(
      ...
      child: Padding(
        ...
        child: Consumer<SingleVideoProvider>(
          builder: (context, provider, child) {
            return Wrap(
              runSpacing: 10.v,
              spacing: 10.h,
              children: List<Widget>.generate(
                provider.singleVideoModelObj.tagsItemList.length,
                (index) {
                  TagsItemModel model =
                      provider.singleVideoModelObj.tagsItemList[index];
