...
import 'package:the_4_08_shopsie___e_commerce_app/data/models/selectionPopupModel/selection_popup_model.dart';
...
class MainLandingModel {
  ...
  Rx<List<ThirtytwoItemModel>> thirtytwoItemList = Rx([
    ThirtytwoItemModel(
