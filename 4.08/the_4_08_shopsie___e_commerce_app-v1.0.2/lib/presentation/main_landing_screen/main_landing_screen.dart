...
import 'package:the_4_08_shopsie___e_commerce_app/widgets/app_bar/appbar_trailing_image.dart';
import 'package:the_4_08_shopsie___e_commerce_app/widgets/app_bar/custom_app_bar.dart';
import 'package:the_4_08_shopsie___e_commerce_app/widgets/custom_drop_down.dart';
...
class MainLandingScreen extends GetWidget<MainLandingController> {
          ...
          Obx(
            () => ListView.separated(
              ...
              itemCount: controller
                  .mainLandingModelObj.value.thirtytwoItemList.value.length,
              itemBuilder: (context, index) {
                ThirtytwoItemModel model = controller
                    .mainLandingModelObj.value.thirtytwoItemList.value[index];
  ...
  /// Section Widget
  Widget _buildRecommendationFilters() {
    return Container(
      padding: EdgeInsets.symmetric(horizontal: 16.h),
      child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: CustomDropDown(
                    ...
                    items: controller
                        .mainLandingModelObj.value.dropdownItemList!.value,
                    onChanged: (value) {
                ...
                Padding(
                  ...
                  child: CustomDropDown(
                    ...
                    items: controller
                        .mainLandingModelObj.value.dropdownItemList1!.value,
                    onChanged: (value) {
            ...
            children: [
              ...
              Padding(
                ...
                child: CustomDropDown(
                  ...
                  hintText: "lbl_all".tr,
                  items: controller
                      .mainLandingModelObj.value.dropdownItemList2!.value,
                  onChanged: (value) {
