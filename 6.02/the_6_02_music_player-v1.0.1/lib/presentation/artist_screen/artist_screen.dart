...
import 'notifier/artist_notifier.dart';
...
class ArtistScreenState extends ConsumerState<ArtistScreen> {
  @override
    ...
    return SizedBox(
        ...
        child: Consumer(builder: (context, ref, _) {
          return ListView.separated(
              ...
              itemCount: ref
                      .watch(artistNotifier)
                      .artistModelObj
                      ?.renaissanceItemList
                      .length ??
                  0,
              itemBuilder: (context, index) {
                RenaissanceItemModel model = ref
                        .watch(artistNotifier)
                        .artistModelObj
                        ?.renaissanceItemList[index] ??
