...
import 'notifier/album_details_notifier.dart';
...
class AlbumDetailsScreenState extends ConsumerState<AlbumDetailsScreen> {
  @override
  ...
  Widget _buildSongsList(BuildContext context) {
    return Consumer(builder: (context, ref, _) {
      return ListView.separated(
          ...
          itemCount: ref
                  .watch(albumDetailsNotifier)
                  .albumDetailsModelObj
                  ?.songslistItemList
                  .length ??
              0,
          itemBuilder: (context, index) {
            SongslistItemModel model = ref
                    .watch(albumDetailsNotifier)
                    .albumDetailsModelObj
