          ...
          SizedBox(
              ...
              child: Consumer<StoriesAndTweetsProvider>(
                ...
                return ListView.separated(
                    ...
                    itemCount:
                        provider.storiesAndTweetsModelObj.liveItemList.length,
                    itemBuilder: (context, index) {
                      LiveItemModel model =
                          provider.storiesAndTweetsModelObj.liveItemList[index];
  ...
  Widget _buildFrame(BuildContext context) {
    return Consumer<StoriesAndTweetsProvider>(
      ...
      return ListView.separated(
          ...
          itemCount: provider.storiesAndTweetsModelObj.frame1ItemList.length,
          itemBuilder: (context, index) {
            Frame1ItemModel model =
                provider.storiesAndTweetsModelObj.frame1ItemList[index];
