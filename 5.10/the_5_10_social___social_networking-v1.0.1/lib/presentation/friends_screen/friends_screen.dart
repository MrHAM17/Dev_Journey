...
import 'package:the_5_10_social___social_networking/widgets/custom_search_view.dart';
                ...
                child: SingleChildScrollView(
                    ...
                    child: Column(children: [
                      ...
                      Padding(
                          ...
                          child:
                              Selector<FriendsProvider, TextEditingController?>(
          ...
          SizedBox(
              ...
              child: Consumer<FriendsProvider>(
                ...
                return ListView.separated(
                    ...
                    itemCount:
                        provider.friendsModelObj.eightythreeItemList.length,
                    itemBuilder: (context, index) {
                      EightythreeItemModel model =
                          provider.friendsModelObj.eightythreeItemList[index];
