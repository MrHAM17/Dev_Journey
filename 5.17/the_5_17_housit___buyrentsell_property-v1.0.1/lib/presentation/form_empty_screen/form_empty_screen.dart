import 'models/form_empty_model.dart';import 'package:flutter/material.dart';import 'package:the_5_17_housit___buyrentsell_property/core/app_export.dart';import 'package:the_5_17_housit___buyrentsell_property/core/utils/validation_functions.dart';import 'package:the_5_17_housit___buyrentsell_property/widgets/app_bar/appbar_leading_iconbutton.dart';import 'package:the_5_17_housit___buyrentsell_property/widgets/app_bar/custom_app_bar.dart';import 'package:the_5_17_housit___buyrentsell_property/widgets/custom_elevated_button.dart';import 'package:the_5_17_housit___buyrentsell_property/widgets/custom_text_form_field.dart';import 'provider/form_empty_provider.dart';import 'package:the_5_17_housit___buyrentsell_property/domain/googleauth/google_auth_helper.dart';import 'package:the_5_17_housit___buyrentsell_property/domain/facebookauth/facebook_auth_helper.dart';class FormEmptyScreen extends StatefulWidget {const FormEmptyScreen({Key? key}) : super(key: key);

@override FormEmptyScreenState createState() =>  FormEmptyScreenState();

static Widget builder(BuildContext context) { return ChangeNotifierProvider(create: (context) => FormEmptyProvider(), child: FormEmptyScreen()); } 
 }

// ignore_for_file: must_be_immutable
class FormEmptyScreenState extends State<FormEmptyScreen> {GlobalKey<FormState> _formKey = GlobalKey<FormState>();

@override void initState() { super.initState();NavigatorService.pushNamed(AppRoutes.registerFormEmptyScreen, ); } 
