...
import 'provider/edit_success_provider.dart';

// ignore_for_file: must_be_immutable
class EditSuccessBottomsheet extends StatefulWidget {
  ...
  @override
  EditSuccessBottomsheetState createState() => EditSuccessBottomsheetState();
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => EditSuccessProvider(),
      child: EditSuccessBottomsheet(),
    );
  }
}

class EditSuccessBottomsheetState extends State<EditSuccessBottomsheet> {
  @override
  void initState() {
    super.initState();
  }
