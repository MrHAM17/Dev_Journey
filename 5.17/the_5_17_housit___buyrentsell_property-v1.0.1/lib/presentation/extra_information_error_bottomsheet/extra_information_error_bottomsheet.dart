...
import 'provider/extra_information_error_provider.dart';

// ignore_for_file: must_be_immutable
class ExtraInformationErrorBottomsheet extends StatefulWidget {
  ...
  @override
  ExtraInformationErrorBottomsheetState createState() =>
      ExtraInformationErrorBottomsheetState();
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => ExtraInformationErrorProvider(),
      child: ExtraInformationErrorBottomsheet(),
    );
  }
}

class ExtraInformationErrorBottomsheetState
    extends State<ExtraInformationErrorBottomsheet> {
  @override
  void initState() {
    super.initState();
  }
