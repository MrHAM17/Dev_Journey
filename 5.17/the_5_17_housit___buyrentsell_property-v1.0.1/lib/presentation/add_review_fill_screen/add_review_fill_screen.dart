...
/// Section Widget
Widget _buildAddReviewFill(BuildContext context) { return Consumer<AddReviewFillProvider>(builder: (context, provider, child) {return GridView.builder(shrinkWrap: true, gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(mainAxisExtent: 162.v, crossAxisCount: 2, mainAxisSpacing: 9.h, crossAxisSpacing: 9.h), physics: NeverScrollableScrollPhysics(), itemCount: provider.addReviewFillModelObj.addreviewfillItemList.length, itemBuilder: (context, index) {AddreviewfillItemModel model = provider.addReviewFillModelObj.addreviewfillItemList[index]; return AddreviewfillItemWidget(model);});}); } 
/// Section Widget
