...
import 'provider/extra_information_success_provider.dart';

// ignore_for_file: must_be_immutable
class ExtraInformationSuccessBottomsheet extends StatefulWidget {
  ...
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => ExtraInformationSuccessProvider(),
...
class ExtraInformationSuccessBottomsheetState
    extends State<ExtraInformationSuccessBottomsheet> {
  @override
  void initState() {
    super.initState();
  }
