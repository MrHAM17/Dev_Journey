import 'dart:async';import 'models/location_empty_model.dart';import 'package:flutter/material.dart';import 'package:google_maps_flutter/google_maps_flutter.dart';import 'package:the_5_17_housit___buyrentsell_property/core/app_export.dart';import 'package:the_5_17_housit___buyrentsell_property/widgets/app_bar/appbar_leading_iconbutton.dart';import 'package:the_5_17_housit___buyrentsell_property/widgets/app_bar/appbar_trailing_button.dart';import 'package:the_5_17_housit___buyrentsell_property/widgets/app_bar/custom_app_bar.dart';import 'package:the_5_17_housit___buyrentsell_property/widgets/custom_elevated_button.dart';import 'provider/location_empty_provider.dart';class LocationEmptyScreen extends StatefulWidget {const LocationEmptyScreen({Key? key}) : super(key: key);

@override LocationEmptyScreenState createState() =>  LocationEmptyScreenState();

static Widget builder(BuildContext context) { return ChangeNotifierProvider(create: (context) => LocationEmptyProvider(), child: LocationEmptyScreen()); } 
 }

// ignore_for_file: must_be_immutable
class LocationEmptyScreenState extends State<LocationEmptyScreen> {Completer<GoogleMapController> googleMapController = Completer();
