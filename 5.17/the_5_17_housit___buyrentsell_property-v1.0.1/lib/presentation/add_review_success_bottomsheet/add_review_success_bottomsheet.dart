...
import 'provider/add_review_success_provider.dart';

// ignore_for_file: must_be_immutable
class AddReviewSuccessBottomsheet extends StatefulWidget {
  ...
  @override
  AddReviewSuccessBottomsheetState createState() =>
      AddReviewSuccessBottomsheetState();
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => AddReviewSuccessProvider(),
      child: AddReviewSuccessBottomsheet(),
    );
  }
}

class AddReviewSuccessBottomsheetState
    extends State<AddReviewSuccessBottomsheet> {
  @override
  void initState() {
    super.initState();
  }
