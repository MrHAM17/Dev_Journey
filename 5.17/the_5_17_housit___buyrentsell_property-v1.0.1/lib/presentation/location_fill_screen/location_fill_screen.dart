import 'dart:async';import 'models/location_fill_model.dart';import 'package:flutter/material.dart';import 'package:google_maps_flutter/google_maps_flutter.dart';import 'package:the_5_17_housit___buyrentsell_property/core/app_export.dart';import 'package:the_5_17_housit___buyrentsell_property/widgets/app_bar/appbar_leading_iconbutton.dart';import 'package:the_5_17_housit___buyrentsell_property/widgets/app_bar/appbar_trailing_button.dart';import 'package:the_5_17_housit___buyrentsell_property/widgets/app_bar/custom_app_bar.dart';import 'package:the_5_17_housit___buyrentsell_property/widgets/custom_elevated_button.dart';import 'provider/location_fill_provider.dart';class LocationFillScreen extends StatefulWidget {const LocationFillScreen({Key? key}) : super(key: key);

@override LocationFillScreenState createState() =>  LocationFillScreenState();

static Widget builder(BuildContext context) { return ChangeNotifierProvider(create: (context) => LocationFillProvider(), child: LocationFillScreen()); } 
 }

// ignore_for_file: must_be_immutable
class LocationFillScreenState extends State<LocationFillScreen> {Completer<GoogleMapController> googleMapController = Completer();
...
/// Section Widget
Widget _buildSelectOnMap(BuildContext context) { return Align(alignment: Alignment.bottomCenter, child: Container(padding: EdgeInsets.symmetric(horizontal: 116.h, vertical: 15.v), decoration: AppDecoration.fillWhiteA, child: Column(mainAxisSize: MainAxisSize.min, mainAxisAlignment: MainAxisAlignment.center, children: [SizedBox(height: 2.v), Text("lbl_select_on_map2".tr, style: CustomTextStyles.titleSmallMedium)]))); } 
/// Section Widget
...
onTapNext(BuildContext context) { NavigatorService.pushNamed(AppRoutes.preferableScreen, ); } 
 }
