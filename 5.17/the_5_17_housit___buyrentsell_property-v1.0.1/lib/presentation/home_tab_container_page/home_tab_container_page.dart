...
import 'package:the_5_17_housit___buyrentsell_property/presentation/home_page/home_page.dart';
import 'package:the_5_17_housit___buyrentsell_property/widgets/app_bar/appbar_title_dropdown.dart';
import 'package:the_5_17_housit___buyrentsell_property/widgets/app_bar/appbar_trailing_circleimage.dart';
import 'package:the_5_17_housit___buyrentsell_property/widgets/app_bar/appbar_trailing_iconbutton_five.dart';
import 'package:the_5_17_housit___buyrentsell_property/widgets/app_bar/custom_app_bar.dart';
import 'package:the_5_17_housit___buyrentsell_property/widgets/custom_search_view.dart';
...
class HomeTabContainerPageState extends State<HomeTabContainerPage>
              ...
              children: [
                ...
                Align(
                  ...
                  child: Padding(
                    ...
                    child: Selector<HomeTabContainerProvider,
  ...
  PreferredSizeWidget _buildAppBar(BuildContext context) {
    return CustomAppBar(
      title: Selector<HomeTabContainerProvider, HomeTabContainerModel?>(
        selector: (
          context,
          provider,
        ) =>
            provider.homeTabContainerModelObj,
        builder: (context, homeTabContainerModelObj, child) {
          return AppbarTitleDropdown(
            margin: EdgeInsets.only(left: 24.h),
            hintText: "msg_jakarta_indonesia".tr,
            items: homeTabContainerModelObj?.dropdownItemList ?? [],
            onTap: (value) {
              context.read<HomeTabContainerProvider>().onSelected(value);
            },
          );
        },
      ),
