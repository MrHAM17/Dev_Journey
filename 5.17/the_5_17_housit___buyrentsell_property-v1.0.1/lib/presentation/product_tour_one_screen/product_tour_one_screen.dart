import 'models/product_tour_one_model.dart';import 'package:flutter/material.dart';import 'package:the_5_17_housit___buyrentsell_property/core/app_export.dart';import 'package:the_5_17_housit___buyrentsell_property/widgets/app_bar/appbar_leading_image.dart';import 'package:the_5_17_housit___buyrentsell_property/widgets/app_bar/appbar_trailing_button.dart';import 'package:the_5_17_housit___buyrentsell_property/widgets/app_bar/custom_app_bar.dart';import 'package:the_5_17_housit___buyrentsell_property/widgets/custom_elevated_button.dart';import 'provider/product_tour_one_provider.dart';class ProductTourOneScreen extends StatefulWidget {const ProductTourOneScreen({Key? key}) : super(key: key);

@override ProductTourOneScreenState createState() =>  ProductTourOneScreenState();

static Widget builder(BuildContext context) { return ChangeNotifierProvider(create: (context) => ProductTourOneProvider(), child: ProductTourOneScreen()); } 
 }
class ProductTourOneScreenState extends State<ProductTourOneScreen> {@override void initState() { super.initState();NavigatorService.pushNamed(AppRoutes.loginScreen, ); } 
