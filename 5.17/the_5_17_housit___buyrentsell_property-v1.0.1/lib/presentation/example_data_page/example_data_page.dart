...
import 'provider/example_data_provider.dart';

// ignore_for_file: must_be_immutable
class ExampleDataPage extends StatefulWidget {
  const ExampleDataPage({Key? key})
      : super(
          key: key,
        );

  @override
  ExampleDataPageState createState() => ExampleDataPageState();
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => ExampleDataProvider(),
      child: ExampleDataPage(),
    );
  }
}

class ExampleDataPageState extends State<ExampleDataPage> {
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(
              height: 120.v,
              child: Consumer<ExampleDataProvider>(
                builder: (context, provider, child) {
                  return ListView.separated(
                    ...
                    itemCount:
                        provider.exampleDataModelObj.layout13ItemList.length,
                    itemBuilder: (context, index) {
                      Layout13ItemModel model =
                          provider.exampleDataModelObj.layout13ItemList[index];
