...
import 'provider/top_agents_profile_detail_provider.dart';
...
class TopAgentsProfileDetailPage extends StatefulWidget {
  ...
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => TopAgentsProfileDetailProvider(),
...
class TopAgentsProfileDetailPageState extends State<TopAgentsProfileDetailPage>
  ...
  Widget _buildTopAgentsProfileDetail(BuildContext context) {
    return Consumer<TopAgentsProfileDetailProvider>(
      builder: (context, provider, child) {
        return GridView.builder(
          ...
          itemCount: provider.topAgentsProfileDetailModelObj
              .topagentsprofiledetailItemList.length,
          itemBuilder: (context, index) {
            TopagentsprofiledetailItemModel model = provider
