...
import 'package:the_5_16_tikpik___short_video__social_networking/presentation/create_new_pin_page/create_new_pin_page.dart';
...
import 'provider/create_new_pin_tab_container_provider.dart';
...
class CreateNewPinTabContainerScreen extends StatefulWidget {
  ...
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => CreateNewPinTabContainerProvider(),
