...
import 'package:the_5_16_tikpik___short_video__social_networking/presentation/posts_add_effects_page/posts_add_effects_page.dart';
import 'provider/posts_add_effects_tab_container_provider.dart';
...
class PostsAddEffectsTabContainerScreen extends StatefulWidget {
  ...
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => PostsAddEffectsTabContainerProvider(),
