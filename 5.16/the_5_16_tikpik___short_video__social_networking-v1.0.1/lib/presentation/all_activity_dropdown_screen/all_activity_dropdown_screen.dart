...
import 'provider/all_activity_dropdown_provider.dart';

class AllActivityDropdownScreen extends StatefulWidget {
  ...
  @override
  AllActivityDropdownScreenState createState() =>
      AllActivityDropdownScreenState();
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => AllActivityDropdownProvider(),
      child: AllActivityDropdownScreen(),
    );
  }
}

class AllActivityDropdownScreenState extends State<AllActivityDropdownScreen> {
  @override
  void initState() {
    super.initState();
  }
      ...
      child: Column(
        ...
        children: [
          CustomAppBar(
            ...
            centerTitle: true,
            title: Selector<AllActivityDropdownProvider,
                AllActivityDropdownModel?>(
              selector: (
                context,
                provider,
              ) =>
                  provider.allActivityDropdownModelObj,
              builder: (context, allActivityDropdownModelObj, child) {
                return AppbarTitleDropdown(
                  hintText: "lbl_all_activity".tr,
                  items: allActivityDropdownModelObj?.dropdownItemList ?? [],
                  onTap: (value) {
                    context
                        .read<AllActivityDropdownProvider>()
                        .onSelected(value);
                  },
                );
              },
