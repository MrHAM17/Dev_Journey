import 'models/walkthrough_one_model.dart';import 'package:flutter/material.dart';import 'package:smooth_page_indicator/smooth_page_indicator.dart';import 'package:the_5_16_tikpik___short_video__social_networking/core/app_export.dart';import 'package:the_5_16_tikpik___short_video__social_networking/widgets/custom_elevated_button.dart';import 'provider/walkthrough_one_provider.dart';class WalkthroughOneScreen extends StatefulWidget {const WalkthroughOneScreen({Key? key}) : super(key: key);

@override WalkthroughOneScreenState createState() =>  WalkthroughOneScreenState();

static Widget builder(BuildContext context) { return ChangeNotifierProvider(create: (context) => WalkthroughOneProvider(), child: WalkthroughOneScreen()); } 
 }
class WalkthroughOneScreenState extends State<WalkthroughOneScreen> {@override void initState() { super.initState(); } 
@override Widget build(BuildContext context) { return SafeArea(child: Scaffold(body: SizedBox(width: double.maxFinite, child: Column(children: [Spacer(), CustomImageView(imagePath: ImageConstant.img10, height: 252.v, width: 365.h), SizedBox(height: 42.v), _buildAutoLayoutVertical(context)])))); } 
/// Section Widget
