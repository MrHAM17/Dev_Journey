...
import 'provider/go_live_together_provider.dart';

// ignore_for_file: must_be_immutable
class GoLiveTogetherBottomsheet extends StatefulWidget {
  ...
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => GoLiveTogetherProvider(),
      child: GoLiveTogetherBottomsheet(),
    );
  }
}

class GoLiveTogetherBottomsheetState extends State<GoLiveTogetherBottomsheet> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Widget _buildGoLiveTogether(BuildContext context) {
    return Consumer<GoLiveTogetherProvider>(
      builder: (context, provider, child) {
        return ListView.separated(
          ...
          itemCount:
              provider.goLiveTogetherModelObj.golivetogetherItemList.length,
          itemBuilder: (context, index) {
            GolivetogetherItemModel model =
                provider.goLiveTogetherModelObj.golivetogetherItemList[index];
