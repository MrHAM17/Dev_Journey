...
import 'provider/home_swipe_up_instructions_provider.dart';

class HomeSwipeUpInstructionsScreen extends StatefulWidget {
  ...
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => HomeSwipeUpInstructionsProvider(),
...
class HomeSwipeUpInstructionsScreenState
    extends State<HomeSwipeUpInstructionsScreen> {
