...
import 'package:the_5_16_tikpik___short_video__social_networking/presentation/rising_stars_page/rising_stars_page.dart';
import 'package:the_5_16_tikpik___short_video__social_networking/presentation/weekly_ranking_page/weekly_ranking_page.dart';
import 'provider/weekly_ranking_tab_container_provider.dart';
...
class WeeklyRankingTabContainerScreen extends StatefulWidget {
  ...
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => WeeklyRankingTabContainerProvider(),
