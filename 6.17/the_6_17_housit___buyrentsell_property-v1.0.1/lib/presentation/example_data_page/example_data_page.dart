...
class ExampleDataPageState extends ConsumerState<ExampleDataPage> {
              ...
              child: Consumer(
                builder: (context, ref, _) {
                  return ListView.separated(
                    ...
                    itemCount: ref
                            .watch(exampleDataNotifier)
                            .exampleDataModelObj
                            ?.layout13ItemList
                            .length ??
                        0,
                    itemBuilder: (context, index) {
                      Layout13ItemModel model = ref
                              .watch(exampleDataNotifier)
                              .exampleDataModelObj
                              ?.layout13ItemList[index] ??
                          Layout13ItemModel();
