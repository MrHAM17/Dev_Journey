...
import 'notifier/horizontal_notifier.dart';
...
class HorizontalScreen extends ConsumerStatefulWidget {
...
class HorizontalScreenState extends ConsumerState<HorizontalScreen> {
  @override
      ...
      child: Consumer(
        builder: (context, ref, _) {
          return ListView.separated(
            ...
            itemCount: ref
                    .watch(horizontalNotifier)
                    .horizontalModelObj
                    ?.horizontalItemList
                    .length ??
                0,
            itemBuilder: (context, index) {
              HorizontalItemModel model = ref
                      .watch(horizontalNotifier)
                      .horizontalModelObj
                      ?.horizontalItemList[index] ??
                  HorizontalItemModel();
