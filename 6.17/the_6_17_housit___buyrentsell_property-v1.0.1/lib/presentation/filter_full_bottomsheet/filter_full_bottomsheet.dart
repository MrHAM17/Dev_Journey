        ...
        Consumer(
          builder: (context, ref, _) {
            return CustomSearchView(
              controller: ref.watch(filterFullNotifier).searchController,
          ...
          children: [
            Consumer(
              builder: (context, ref, _) {
                return CustomTextFormField(
                  width: 138.h,
                  controller: ref.watch(filterFullNotifier).priceController,
                  hintText: "lbl_150".tr,
                  prefix: Container(
            ...
            Consumer(
              builder: (context, ref, _) {
                return CustomTextFormField(
                  width: 138.h,
                  controller: ref.watch(filterFullNotifier).formValueController,
                  hintText: "lbl_350".tr,
