...
class EditProfileScreenState extends ConsumerState<EditProfileScreen> {GlobalKey<FormState> _formKey = GlobalKey<FormState>();
...
/// Section Widget
Widget _buildChooseLocation(BuildContext context) { return CustomElevatedButton(text: "lbl_choose_location".tr, margin: EdgeInsets.only(left: 24.h, right: 24.h, bottom: 24.v)); } 
