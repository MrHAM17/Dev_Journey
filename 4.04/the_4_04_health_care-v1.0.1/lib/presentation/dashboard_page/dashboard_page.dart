...
import 'package:the_4_04_health_care/widgets/app_bar/appbar_title.dart';
...
import 'package:the_4_04_health_care/widgets/custom_search_view.dart';
    ...
    return SizedBox(
        ...
        child: Obx(() => ListView.separated(
            ...
            itemCount: controller
                .dashboardModelObj.value.fortysevenItemList.value.length,
            itemBuilder: (context, index) {
              FortysevenItemModel model = controller
                  .dashboardModelObj.value.fortysevenItemList.value[index];
  ...
  Widget _buildDoctor() {
    return SizedBox(
        ...
        child: Obx(() => ListView.separated(
            ...
            itemCount:
                controller.dashboardModelObj.value.doctorItemList.value.length,
            itemBuilder: (context, index) {
