...
import 'package:the_7_09_social_dashboards_ui_kit/presentation/gallery_page/gallery_page.dart';
import 'package:the_7_09_social_dashboards_ui_kit/presentation/home_page/home_page.dart';
import 'package:the_7_09_social_dashboards_ui_kit/presentation/user_profile_page/user_profile_page.dart';
          ...
          Align(
              ...
              child: Padding(
                  ...
                  child: Column(mainAxisSize: MainAxisSize.min, children: [
                    ...
                    SizedBox(height: 9.v),
                    Text("Edward Ford", style: theme.textTheme.titleLarge),
                    SizedBox(height: 8.v),
                    Text("@edwardford", style: theme.textTheme.bodyMedium)
                  ]))),
          Align(
              ...
              child: Padding(
                  ...
                  child: Column(mainAxisSize: MainAxisSize.min, children: [
                    Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                      Text("518", style: theme.textTheme.titleMedium),
                      Padding(
                      ...
                      Padding(
                          ...
                          child:
                              Text("22k", style: theme.textTheme.titleMedium)),
                      Padding(
