...
import 'package:the_7_14_jusplay___movie_streaming_app/presentation/about_page/about_page.dart';
import 'package:the_7_14_jusplay___movie_streaming_app/presentation/episode_page/episode_page.dart';
import 'package:the_7_14_jusplay___movie_streaming_app/presentation/similiar_page/similiar_page.dart';
import 'package:the_7_14_jusplay___movie_streaming_app/widgets/app_bar/appbar_leading_iconbutton.dart';
import 'package:the_7_14_jusplay___movie_streaming_app/widgets/app_bar/appbar_trailing_iconbutton.dart';
  ...
  Widget _buildTabview(BuildContext context) {
    return Container(
        ...
        child: TabBar(
            ...
            tabs: [
              Tab(child: Text("Episode")),
              Tab(child: Text("Similiar")),
              Tab(child: Opacity(opacity: 0.9, child: Text("About")))
            ]));
  }
