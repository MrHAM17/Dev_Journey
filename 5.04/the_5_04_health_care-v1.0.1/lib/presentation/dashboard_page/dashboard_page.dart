...
import 'package:the_5_04_health_care/widgets/app_bar/appbar_title.dart';
    ...
    return SizedBox(
        ...
        child: Consumer<DashboardProvider>(builder: (context, provider, child) {
          return ListView.separated(
              ...
              itemCount: provider.dashboardModelObj.fortysevenItemList.length,
              itemBuilder: (context, index) {
                FortysevenItemModel model =
                    provider.dashboardModelObj.fortysevenItemList[index];
    ...
    return SizedBox(
        ...
        child: Consumer<DashboardProvider>(builder: (context, provider, child) {
          return ListView.separated(
              ...
              itemCount: provider.dashboardModelObj.doctorItemList.length,
              itemBuilder: (context, index) {
                DoctorItemModel model =
                    provider.dashboardModelObj.doctorItemList[index];
