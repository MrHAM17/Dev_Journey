...
import 'package:the_3_20_movie_streaming/widgets/custom_elevated_button.dart';
import 'package:the_3_20_movie_streaming/widgets/custom_icon_button.dart';
        ...
        child: BlocSelector<DetailPageTwelveBloc, DetailPageTwelveState,
            ...
            builder: (context, detailPageTwelveModelObj) {
              return ListView.separated(
                  ...
                  itemCount:
                      detailPageTwelveModelObj?.movies4ItemList.length ?? 0,
                  itemBuilder: (context, index) {
                    Movies4ItemModel model =
                        detailPageTwelveModelObj?.movies4ItemList[index] ??
                            Movies4ItemModel();
