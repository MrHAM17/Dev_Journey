        ...
        child: BlocSelector<DashboardBloc, DashboardState, DashboardModel?>(
            ...
            builder: (context, dashboardModelObj) {
              return ListView.separated(
                  ...
                  itemCount: dashboardModelObj?.specialsItemList.length ?? 0,
                  itemBuilder: (context, index) {
                    SpecialsItemModel model =
                        dashboardModelObj?.specialsItemList[index] ??
                            SpecialsItemModel();
        ...
        child: BlocSelector<DashboardBloc, DashboardState, DashboardModel?>(
            ...
            builder: (context, dashboardModelObj) {
              return ListView.separated(
                  ...
                  itemCount: dashboardModelObj?.specials1ItemList.length ?? 0,
                  itemBuilder: (context, index) {
                    Specials1ItemModel model =
                        dashboardModelObj?.specials1ItemList[index] ??
                            Specials1ItemModel();
        ...
        child: BlocSelector<DashboardBloc, DashboardState, DashboardModel?>(
            ...
            builder: (context, dashboardModelObj) {
              return ListView.separated(
                  ...
                  itemCount: dashboardModelObj?.specials2ItemList.length ?? 0,
                  itemBuilder: (context, index) {
                    Specials2ItemModel model =
                        dashboardModelObj?.specials2ItemList[index] ??
                            Specials2ItemModel();
        ...
        child: BlocSelector<DashboardBloc, DashboardState, DashboardModel?>(
            ...
            builder: (context, dashboardModelObj) {
              return ListView.separated(
                  ...
                  itemCount: dashboardModelObj?.specials3ItemList.length ?? 0,
                  itemBuilder: (context, index) {
                    Specials3ItemModel model =
                        dashboardModelObj?.specials3ItemList[index] ??
                            Specials3ItemModel();
        ...
        child: BlocSelector<DashboardBloc, DashboardState, DashboardModel?>(
            ...
            builder: (context, dashboardModelObj) {
              return ListView.separated(
                  ...
                  itemCount: dashboardModelObj?.specials4ItemList.length ?? 0,
                  itemBuilder: (context, index) {
                    Specials4ItemModel model =
                        dashboardModelObj?.specials4ItemList[index] ??
                            Specials4ItemModel();
        ...
        child: BlocSelector<DashboardBloc, DashboardState, DashboardModel?>(
            ...
            builder: (context, dashboardModelObj) {
              return ListView.separated(
                  ...
                  itemCount: dashboardModelObj?.specials5ItemList.length ?? 0,
                  itemBuilder: (context, index) {
                    Specials5ItemModel model =
                        dashboardModelObj?.specials5ItemList[index] ??
                            Specials5ItemModel();
