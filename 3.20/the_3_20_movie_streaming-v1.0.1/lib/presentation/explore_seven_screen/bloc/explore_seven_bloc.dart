...
import 'package:the_3_20_movie_streaming/presentation/explore_seven_screen/models/explore_seven_model.dart';
  ...
  _onInitialize(
    ...
    emit(state.copyWith(
        exploreSevenModelObj: state.exploreSevenModelObj?.copyWith(
            specials6ItemList: fillSpecials6ItemList(),
            ioItemList: fillIoItemList(),
            turnerhoochItemList: fillTurnerhoochItemList())));
  }

  List<Specials6ItemModel> fillSpecials6ItemList() {
    return [
      Specials6ItemModel(
