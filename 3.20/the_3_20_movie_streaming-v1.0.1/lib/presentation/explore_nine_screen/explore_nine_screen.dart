...
class ExploreNineScreen extends StatelessWidget {
            ...
            BlocSelector<ExploreNineBloc, ExploreNineState, ExploreNineModel?>(
                ...
                builder: (context, exploreNineModelObj) {
                  return ListView.separated(
                      ...
                      itemCount:
                          exploreNineModelObj?.specials8ItemList.length ?? 0,
                      itemBuilder: (context, index) {
                        Specials8ItemModel model =
                            exploreNineModelObj?.specials8ItemList[index] ??
                                Specials8ItemModel();
  ...
  Widget _buildExploreNine(BuildContext context) {
    return BlocSelector<ExploreNineBloc, ExploreNineState, ExploreNineModel?>(
        selector: (state) => state.exploreNineModelObj,
        builder: (context, exploreNineModelObj) {
          return GridView.builder(
              ...
              itemCount: exploreNineModelObj?.explorenineItemList.length ?? 0,
              itemBuilder: (context, index) {
