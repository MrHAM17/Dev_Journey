...
class DetailPageNineScreen extends StatelessWidget {
  ...
  Widget _buildFrameFiftyThree(BuildContext context) {
    return BlocSelector<DetailPageNineBloc, DetailPageNineState,
            DetailPageNineModel?>(
        ...
        builder: (context, detailPageNineModelObj) {
          return Wrap(
              ...
              children: List<Widget>.generate(
                  detailPageNineModelObj?.framefiftythreeItemList.length ?? 0,
                  (index) {
                FramefiftythreeItemModel model =
                    detailPageNineModelObj?.framefiftythreeItemList[index] ??
