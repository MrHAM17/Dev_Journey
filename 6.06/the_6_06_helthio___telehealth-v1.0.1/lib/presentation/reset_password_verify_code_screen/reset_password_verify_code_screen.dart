import 'notifier/reset_password_verify_code_notifier.dart';
...
import 'package:the_6_06_helthio___telehealth/widgets/custom_pin_code_text_field.dart';

class ResetPasswordVerifyCodeScreen extends ConsumerStatefulWidget {
  const ResetPasswordVerifyCodeScreen({Key? key}) : super(key: key);

  @override
  ResetPasswordVerifyCodeScreenState createState() =>
      ResetPasswordVerifyCodeScreenState();
}

class ResetPasswordVerifyCodeScreenState
    extends ConsumerState<ResetPasswordVerifyCodeScreen> {
  @override
                  ...
                  Padding(
                      ...
                      child: Consumer(builder: (context, ref, _) {
                        return CustomPinCodeTextField(
                            context: context,
                            controller: ref
                                .watch(resetPasswordVerifyCodeNotifier)
                                .otpController,
                            onChanged: (value) {
                              ref
                                  .watch(resetPasswordVerifyCodeNotifier)
