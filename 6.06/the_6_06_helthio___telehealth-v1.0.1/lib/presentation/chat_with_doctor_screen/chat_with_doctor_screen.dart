import 'notifier/chat_with_doctor_notifier.dart';
...
import 'package:the_6_06_helthio___telehealth/widgets/app_bar/appbar_subtitle_three.dart';
...
class ChatWithDoctorScreenState extends ConsumerState<ChatWithDoctorScreen> {
  @override
  Widget build(BuildContext context) {
    return SafeArea(
        child: Scaffold(
            ...
            bottomNavigationBar: _buildSeventySix(context)));
  }
  ...
  Widget _buildEightyEight(BuildContext context) {
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      Padding(
          padding: EdgeInsets.only(left: 90.h),
          child:
              _buildChatTile(context, iDonTHaveAny: "msg_i_have_suffering".tr))
    ]);
  }
  ...
  Widget _buildSeventyTwo(BuildContext context) {
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      _buildProfile(context,
          drMarcusHorizon: "msg_dr_marcus_horizon".tr, time: "lbl_online".tr),
      SizedBox(height: 10.v),
      Container(
          height: 22.v,
          width: 58.h,
        ...
        child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
          Consumer(builder: (context, ref, _) {
            return CustomTextFormField(
                width: 207.h,
                controller: ref.watch(chatWithDoctorNotifier).messageController,
