import 'notifier/reset_password_email_notifier.dart';
...
class ResetPasswordEmailPage extends ConsumerStatefulWidget {
...
class ResetPasswordEmailPageState extends ConsumerState<ResetPasswordEmailPage>
        ...
        child: Column(children: [
          Consumer(builder: (context, ref, _) {
            return CustomTextFormField(
                controller:
                    ref.watch(resetPasswordEmailNotifier).emailController,
