import 'notifier/sign_up_success_notifier.dart';
...
class SignUpSuccessDialog extends ConsumerStatefulWidget {
  const SignUpSuccessDialog({Key? key}) : super(key: key);

  @override
  SignUpSuccessDialogState createState() => SignUpSuccessDialogState();
}

class SignUpSuccessDialogState extends ConsumerState<SignUpSuccessDialog> {
  @override
