import 'notifier/drugs_detail_notifier.dart';
...
import 'package:the_6_06_helthio___telehealth/widgets/custom_rating_bar.dart';

class DrugsDetailScreen extends ConsumerStatefulWidget {
  const DrugsDetailScreen({Key? key}) : super(key: key);

  @override
  DrugsDetailScreenState createState() => DrugsDetailScreenState();
}

class DrugsDetailScreenState extends ConsumerState<DrugsDetailScreen> {
  @override
  Widget build(BuildContext context) {
    return SafeArea(
        child: Scaffold(
            ...
            bottomNavigationBar: _buildThirty(context)));
  }
