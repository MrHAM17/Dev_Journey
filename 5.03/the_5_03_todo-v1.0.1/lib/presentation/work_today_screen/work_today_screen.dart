...
import 'provider/work_today_provider.dart';
...
class WorkTodayScreen extends StatefulWidget {
  ...
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
        create: (context) => WorkTodayProvider(), child: WorkTodayScreen());
  }
}

class WorkTodayScreenState extends State<WorkTodayScreen> {
  @override
  void initState() {
    super.initState();
  }
