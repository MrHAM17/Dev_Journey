...
class SpinnerChevronrightFourAdapter(
  private val mContext: Context,
  @LayoutRes
  private val layoutResource: Int,
  private val allItems: List<SpinnerChevronrightFourModel>
) : ArrayAdapter<SpinnerChevronrightFourModel>(mContext, layoutResource, allItems) {
