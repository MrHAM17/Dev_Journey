...
class SpinnerChevronrightThreeAdapter(
  private val mContext: Context,
  @LayoutRes
  private val layoutResource: Int,
  private val allItems: List<SpinnerChevronrightThreeModel>
) : ArrayAdapter<SpinnerChevronrightThreeModel>(mContext, layoutResource, allItems) {
