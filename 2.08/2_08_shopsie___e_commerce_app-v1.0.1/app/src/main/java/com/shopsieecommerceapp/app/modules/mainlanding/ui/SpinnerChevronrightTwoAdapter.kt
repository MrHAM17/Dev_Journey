...
class SpinnerChevronrightTwoAdapter(
  private val mContext: Context,
  @LayoutRes
  private val layoutResource: Int,
  private val allItems: List<SpinnerChevronrightTwoModel>
) : ArrayAdapter<SpinnerChevronrightTwoModel>(mContext, layoutResource, allItems) {
