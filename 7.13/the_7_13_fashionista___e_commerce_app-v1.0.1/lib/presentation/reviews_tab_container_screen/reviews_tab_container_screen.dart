...
import 'package:the_7_13_fashionista___e_commerce_app/presentation/reviews_page/reviews_page.dart';
...
class ReviewsTabContainerScreenState extends State<ReviewsTabContainerScreen>
  ...
  PreferredSizeWidget _buildAppBar(BuildContext context) {
    return CustomAppBar(
        ...
        centerTitle: true,
        title: AppbarSubtitleOne(text: "Reviews"));
  }
  ...
  Widget _buildTabview(BuildContext context) {
    return Container(
        ...
        child: TabBar(
            ...
            tabs: [
              Tab(child: Text("Positive")),
              Tab(child: Text("Negetive"))
            ]));
  }
