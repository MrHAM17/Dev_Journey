...
class InformationScreen extends StatelessWidget {
  ...
  PreferredSizeWidget _buildAppBar(BuildContext context) {
    return CustomAppBar(
        ...
        centerTitle: true,
        title: AppbarSubtitleOne(text: "Information"));
  }
  ...
  Widget _buildInputFieldWith(BuildContext context) {
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      SizedBox(height: 8.v),
      CustomTextFormField(
          controller: nameController, hintText: "Anne Christion")
    ]);
  }
  ...
  Widget _buildInputFieldWith1(BuildContext context) {
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      SizedBox(height: 8.v),
      CustomTextFormField(
          controller: dateOfBirthController, hintText: "11-01-1997")
    ]);
  }
  ...
  Widget _buildInputFieldWith2(BuildContext context) {
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      SizedBox(height: 8.v),
      CustomTextFormField(
          controller: addressController, hintText: "New south Wales, Austraila")
    ]);
  }
