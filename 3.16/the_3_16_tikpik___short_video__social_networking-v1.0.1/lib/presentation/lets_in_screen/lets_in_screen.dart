import 'bloc/lets_in_bloc.dart';import 'models/lets_in_model.dart';import 'package:flutter/material.dart';import 'package:the_3_16_tikpik___short_video__social_networking/core/app_export.dart';import 'package:the_3_16_tikpik___short_video__social_networking/widgets/app_bar/appbar_leading_image.dart';import 'package:the_3_16_tikpik___short_video__social_networking/widgets/app_bar/custom_app_bar.dart';import 'package:the_3_16_tikpik___short_video__social_networking/widgets/custom_elevated_button.dart';import 'package:the_3_16_tikpik___short_video__social_networking/widgets/custom_outlined_button.dart';import 'package:the_3_16_tikpik___short_video__social_networking/domain/facebookauth/facebook_auth_helper.dart';import 'package:the_3_16_tikpik___short_video__social_networking/domain/googleauth/google_auth_helper.dart';class LetsInScreen extends StatelessWidget {const LetsInScreen({Key? key}) : super(key: key);

static Widget builder(BuildContext context) { return BlocProvider<LetsInBloc>(create: (context) => LetsInBloc(LetsInState(letsInModelObj: LetsInModel()))..add(LetsInInitialEvent()), child: LetsInScreen()); } 
@override Widget build(BuildContext context) { return BlocBuilder<LetsInBloc, LetsInState>(builder: (context, state) {return SafeArea(child: Scaffold(appBar: _buildAppBar(context), body: Container(width: double.maxFinite, padding: EdgeInsets.symmetric(horizontal: 24.h, vertical: 47.v), child: Column(children: [SizedBox(height: 41.v), Text("msg_let_s_sign_you_in".tr, style: theme.textTheme.displayMedium), SizedBox(height: 63.v), _buildContinueWithGoogle(context), SizedBox(height: 16.v), _buildContinueWithFacebook(context), SizedBox(height: 16.v), _buildContinueWithApple(context), SizedBox(height: 37.v), _buildAutoLayoutHorizontal(context), SizedBox(height: 33.v), _buildSignInWithPassword(context), Spacer(), Row(mainAxisAlignment: MainAxisAlignment.center, children: [Padding(padding: EdgeInsets.only(bottom: 1.v), child: Text("msg_don_t_have_an_account".tr, style: theme.textTheme.bodyMedium)), GestureDetector(onTap: () {onTapTxtSignUp(context);}, child: Padding(padding: EdgeInsets.only(left: 8.h), child: Text("lbl_sign_up".tr, style: CustomTextStyles.titleSmallPrimary)))])]))));}); } 
/// Section Widget
