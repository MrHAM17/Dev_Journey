      ...
      child: Column(
        ...
        children: [
          CustomAppBar(
            ...
            centerTitle: true,
            title: BlocSelector<AllActivityDropdownBloc,
                AllActivityDropdownState, AllActivityDropdownModel?>(
              selector: (state) => state.allActivityDropdownModelObj,
