...
class TrendingHashtagPageState extends State<TrendingHashtagPage>
  ...
  Widget _buildAutoLayoutHorizontal(BuildContext context) {
    return SizedBox(
      height: 200.v,
      child: BlocSelector<TrendingHashtagBloc, TrendingHashtagState,
        ...
        builder: (context, trendingHashtagModelObj) {
          return ListView.separated(
            ...
            itemBuilder: (context, index) {
              Autolayouthorizontal3ItemModel model = trendingHashtagModelObj
          ...
          return ListView.separated(
            ...
            itemCount:
                trendingHashtagModelObj?.autolayouthorizontal4ItemList.length ??
                    0,
            itemBuilder: (context, index) {
              Autolayouthorizontal4ItemModel model = trendingHashtagModelObj
