import 'bloc/add_option_bloc.dart';
...
class AddOptionScreen extends StatelessWidget {
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<AddOptionBloc>(
      create: (context) => AddOptionBloc(AddOptionState(
        addOptionModelObj: AddOptionModel(),
      ))
        ..add(AddOptionInitialEvent()),
      ...
      children: [
        ...
        SizedBox(
          ...
          child: Stack(
            ...
            children: [
              BlocSelector<AddOptionBloc, AddOptionState,
                  TextEditingController?>(
                selector: (state) => state.stateInactiveController,
                builder: (context, stateInactiveController) {
              ...
              BlocSelector<AddOptionBloc, AddOptionState,
                  TextEditingController?>(
                selector: (state) => state.stateInactiveController1,
                builder: (context, stateInactiveController1) {
                  return CustomTextFormField(
                    width: 160.h,
