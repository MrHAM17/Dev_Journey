...
class TrendingSoundsPageState extends State<TrendingSoundsPage>
  ...
  Widget _buildAutoLayoutHorizontal(BuildContext context) {
    return SizedBox(
      height: 200.v,
      child: BlocSelector<TrendingSoundsBloc, TrendingSoundsState,
          TrendingSoundsModel?>(
        ...
        builder: (context, trendingSoundsModelObj) {
          return ListView.separated(
            ...
            itemBuilder: (context, index) {
              Autolayouthorizontal1ItemModel model = trendingSoundsModelObj
          ...
          return ListView.separated(
            ...
            itemCount:
                trendingSoundsModelObj?.autolayouthorizontal2ItemList.length ??
                    0,
            itemBuilder: (context, index) {
              Autolayouthorizontal2ItemModel model = trendingSoundsModelObj
