import 'bloc/home_swipe_up_instructions_bloc.dart';
import 'models/home_swipe_up_instructions_model.dart';
import 'package:flutter/material.dart';
import 'package:the_3_16_tikpik___short_video__social_networking/core/app_export.dart';
import 'package:the_3_16_tikpik___short_video__social_networking/presentation/all_activity_page/all_activity_page.dart';
import 'package:the_3_16_tikpik___short_video__social_networking/presentation/home_page/home_page.dart';
import 'package:the_3_16_tikpik___short_video__social_networking/presentation/profile_two_page/profile_two_page.dart';
import 'package:the_3_16_tikpik___short_video__social_networking/presentation/trending_sounds_tab_container_page/trending_sounds_tab_container_page.dart';
...
import 'package:the_3_16_tikpik___short_video__social_networking/widgets/custom_bottom_bar.dart';

class HomeSwipeUpInstructionsScreen extends StatelessWidget {
  HomeSwipeUpInstructionsScreen({Key? key})
      : super(
          key: key,
        );
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<HomeSwipeUpInstructionsBloc>(
      create: (context) =>
          HomeSwipeUpInstructionsBloc(HomeSwipeUpInstructionsState(
        homeSwipeUpInstructionsModelObj: HomeSwipeUpInstructionsModel(),
      ))
            ..add(HomeSwipeUpInstructionsInitialEvent()),
      child: HomeSwipeUpInstructionsScreen(),
    );
  }

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<HomeSwipeUpInstructionsBloc,
        HomeSwipeUpInstructionsState>(
