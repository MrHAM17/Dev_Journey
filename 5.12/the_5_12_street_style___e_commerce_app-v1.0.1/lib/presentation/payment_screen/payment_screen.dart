...
import 'package:the_5_12_street_style___e_commerce_app/widgets/custom_text_form_field.dart';
...
class PaymentScreen extends StatefulWidget {
  ...
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
        create: (context) => PaymentProvider(), child: PaymentScreen());
  }
}
          ...
          Padding(
              ...
              child: Consumer<PaymentProvider>(
                ...
                return CarouselSlider.builder(
                    ...
                    itemCount: provider.paymentModelObj.cardItemList.length,
                    itemBuilder: (context, index, realIndex) {
                      CardItemModel model =
                          provider.paymentModelObj.cardItemList[index];
            ...
            child: Column(
                ...
                children: [
                  Text("lbl_payment_option".tr,
                      style: CustomTextStyles.titleLargeBlack900),
                  SizedBox(height: 15.v),
                  Selector<PaymentProvider, TextEditingController?>(
                      selector: (context, provider) =>
                          provider.applePayController,
                      builder: (context, applePayController, child) {
