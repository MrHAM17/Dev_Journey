...
import 'package:the_5_12_street_style___e_commerce_app/widgets/custom_elevated_button.dart';
import 'package:the_5_12_street_style___e_commerce_app/widgets/custom_outlined_button.dart';
...
class ShopScreen extends StatefulWidget {
  ...
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
        create: (context) => ShopProvider(), child: ShopScreen());
  }
}
  ...
  Widget _buildShop(BuildContext context) {
    return Consumer<ShopProvider>(builder: (context, provider, child) {
      return GridView.builder(
          ...
          itemCount: provider.shopModelObj.shopItemList.length,
          itemBuilder: (context, index) {
            ShopItemModel model = provider.shopModelObj.shopItemList[index];
