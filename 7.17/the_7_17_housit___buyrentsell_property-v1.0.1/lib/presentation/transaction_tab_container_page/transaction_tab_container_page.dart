import 'package:flutter/material.dart';import 'package:the_7_17_housit___buyrentsell_property/core/app_export.dart';import 'package:the_7_17_housit___buyrentsell_property/presentation/listings_page/listings_page.dart';import 'package:the_7_17_housit___buyrentsell_property/widgets/app_bar/appbar_subtitle.dart';import 'package:the_7_17_housit___buyrentsell_property/widgets/app_bar/appbar_trailing_iconbutton.dart';import 'package:the_7_17_housit___buyrentsell_property/widgets/app_bar/custom_app_bar.dart';import 'package:the_7_17_housit___buyrentsell_property/widgets/custom_icon_button.dart';class TransactionTabContainerPage extends StatefulWidget {const TransactionTabContainerPage({Key? key}) : super(key: key);
...
/// Common widget
Widget _buildInformationReviews(BuildContext context) { return Container(padding: EdgeInsets.symmetric(horizontal: 36.h, vertical: 14.v), decoration: AppDecoration.outlineBluegray50.copyWith(borderRadius: BorderRadiusStyle.circleBorder20), child: Column(mainAxisSize: MainAxisSize.min, children: [Text("12", style: CustomTextStyles.titleSmallBold), SizedBox(height: 5.v), Text("Sold", style: CustomTextStyles.labelLargeBluegray600)])); } 
